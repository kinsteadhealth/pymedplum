...
class Appointment(MedplumFHIRBase):
    ...
    resource_type: Literal["Appointment"] = Field(
        default="Appointment", alias="resourceType"
    )
    ...
    cancelation_reason: Optional[CodeableConcept] = Field(
        default=None,
    ...
    service_category: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="serviceCategory",
        description="A broad categorization of the service that is to be performed during this appointment.",
    )
    service_type: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="serviceType",
    ...
    appointment_type: Optional[CodeableConcept] = Field(
        default=None,
    ...
    minutes_duration: Optional[Union[int, float]] = Field(
        default=None,
    ...
    patient_instruction: Optional[str] = Field(
        default=None,
    ...
    participant: list[AppointmentParticipant] = Field(
        default=..., description="List of participants involved in the appointment."
    )
    requested_period: Optional[list[Period]] = Field(
        default=None,
...
class AppointmentParticipant(MedplumFHIRBase):
    ...
    type: Optional[list[CodeableConcept]] = Field(
        default=None, description="Role of participant in the appointment."
    )
    ...
    status: Literal["accepted", "declined", "tentative", "needs-action"] = Field(
        default=..., description="Participation status of the actor."
    )
    period: Optional[Period] = Field(
        default=None, description="Participation period of the actor."
    )
