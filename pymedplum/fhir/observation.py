...
class Observation(MedplumFHIRBase):
    ...
    status: Literal[
        ...
        "entered-in-error",
        "unknown",
    ] = Field(default=..., description="The status of the result value.")
    ...
    interpretation: list[CodeableConcept] | None = Field(
        default=None,
    ...
    reference_range: list[ObservationReferenceRange] | None = Field(
        default=None,
    ...
    has_member: list[Reference] | None = Field(
        default=None,
        alias="hasMember",
    ...
    component: list[ObservationComponent] | None = Field(
        default=None,
