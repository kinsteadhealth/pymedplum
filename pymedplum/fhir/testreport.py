...
class TestReport(MedplumFHIRBase):
    ...
    resource_type: Literal["TestReport"] = Field(
        default="TestReport", alias="resourceType"
    )
    ...
    ] = Field(default=..., description="The current state of this test report.")
    test_script: Reference = Field(
        default=...,
        alias="testScript",
    ...
    participant: list[TestReportParticipant] | None = Field(
        default=None,
    ...
    test: list[TestReportTest] | None = Field(
...
class TestReportParticipant(MedplumFHIRBase):
    ...
    type: Literal["test-engine", "client", "server"] = Field(
        default=..., description="The type of participant."
    )
    uri: str = Field(
        default=...,
    ...
    display: str | None = Field(
        default=None, description="The display name of the participant."
    )
...
class TestReportSetup(MedplumFHIRBase):
    ...
    action: list[TestReportSetupAction] = Field(
        default=...,
...
class TestReportSetupActionAssert(MedplumFHIRBase):
    ...
    result: Literal["pass", "skip", "fail", "warning", "error"] = Field(
        default=..., description="The result of this assertion."
    )
    message: str | None = Field(
        default=None, description="An explanatory message associated with the result."
    )
    detail: str | None = Field(
        default=None, description="A link to further details on the result."
    )
...
class TestReportSetupActionOperation(MedplumFHIRBase):
    ...
    result: Literal["pass", "skip", "fail", "warning", "error"] = Field(
        default=..., description="The result of this operation."
    )
    message: str | None = Field(
        default=None, description="An explanatory message associated with the result."
    )
...
class TestReportTeardown(MedplumFHIRBase):
    ...
    action: list[TestReportTeardownAction] = Field(
...
class TestReportTest(MedplumFHIRBase):
    ...
    action: list[TestReportTestAction] = Field(
        default=...,
        description="Action would contain either an operation or an assertion.",
    )
