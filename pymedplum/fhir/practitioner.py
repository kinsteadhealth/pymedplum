...
class Practitioner(MedplumFHIRBase):
    ...
    identifier: Optional[list[Identifier]] = Field(default=None, description="An identifier that applies to this person in this role.")
    active: Optional[bool] = Field(default=None, description="Whether this practitioner's record is in active use.")
    name: Optional[list[HumanName]] = Field(default=None, description="The name(s) associated with the practitioner.")
    telecom: Optional[list[ContactPoint]] = Field(default=None, description="A contact detail for the practitioner, e.g. a telephone number or an email address.")
    address: Optional[list[Address]] = Field(default=None, description="Address(es) of the practitioner that are not role specific (typically home address). Work addresses are not typically entered in this property as they are usually role dependent.")
    ...
    birth_date: Optional[str] = Field(default=None, alias="birthDate", description="The date of birth for the practitioner.")
    photo: Optional[list[Attachment]] = Field(default=None, description="Image of the person.")
    qualification: Optional[list[PractitionerQualification]] = Field(default=None, description="The official certifications, training, and licenses that authorize or otherwise pertain to the provision of care by the practitioner. For example, a medical license issued by a medical board authorizing the practitioner to practice medicine within a certian locality.")
    communication: Optional[list[CodeableConcept]] = Field(default=None, description="A language the practitioner can use in patient communication.")
...
class PractitionerQualification(MedplumFHIRBase):
    ...
    identifier: Optional[list[Identifier]] = Field(default=None, description="An identifier that applies to this person's qualification in this role.")
    code: CodeableConcept = Field(default=..., description="Coded representation of the qualification.")
    period: Optional[Period] = Field(default=None, description="Period during which the qualification is valid.")
    issuer: Optional[Reference] = Field(default=None, description="Organization that regulates and issues the qualification.")
