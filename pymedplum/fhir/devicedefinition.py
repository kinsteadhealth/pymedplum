...
class DeviceDefinition(MedplumFHIRBase):
    ...
    udi_device_identifier: Optional[List[DeviceDefinitionUdiDeviceIdentifier]] = Field(
        default=None,
    ...
    manufacturer_string: Optional[str] = Field(
        default=None,
        alias="manufacturerString",
        description="A name of the manufacturer.",
    )
    manufacturer_reference: Optional[Reference] = Field(
        default=None,
        alias="manufacturerReference",
        description="A name of the manufacturer.",
    )
    device_name: Optional[List[DeviceDefinitionDeviceName]] = Field(
        default=None,
        alias="deviceName",
    ...
    language_code: Optional[List[CodeableConcept]] = Field(
        default=None,
        alias="languageCode",
    ...
    property: Optional[List[DeviceDefinitionProperty]] = Field(
        default=None,
    ...
    online_information: Optional[str] = Field(
        default=None,
    ...
    parent_device: Optional[Reference] = Field(
        default=None,
        alias="parentDevice",
...
class DeviceDefinitionProperty(MedplumFHIRBase):
    ...
    value_quantity: Optional[List[Quantity]] = Field(
        default=None, alias="valueQuantity", description="Property value as a quantity."
    )
    value_code: Optional[List[CodeableConcept]] = Field(
        default=None,
        alias="valueCode",
