...
class SearchParameter(MedplumFHIRBase):
    ...
    multiple_and: Optional[bool] = Field(
        default=None,
        alias="multipleAnd",
    ...
    comparator: Optional[
        list[Literal["eq", "ne", "gt", "lt", "ge", "le", "sa", "eb", "ap"]]
    ] = Field(
