...
class BodyStructure(MedplumFHIRBase):
    ...
    resource_type: Literal["BodyStructure"] = Field(
    ...
    identifier: Optional[list[Identifier]] = Field(default=None, description="Identifier for this instance of the anatomical structure.")
    active: Optional[bool] = Field(default=None, description="Whether this body site is in active use.")
    morphology: Optional[CodeableConcept] = Field(default=None, description="The kind of structure being represented by the body structure at `BodyStructure.location`. This can define both normal and abnormal morphologies.")
    location: Optional[CodeableConcept] = Field(default=None, description="The anatomical location or region of the specimen, lesion, or body structure.")
    location_qualifier: Optional[list[CodeableConcept]] = Field(default=None, alias="locationQualifier", description="Qualifier to refine the anatomical location. These include qualifiers for laterality, relative location, directionality, number, and plane.")
    description: Optional[str] = Field(default=None, description="A summary, characterization or explanation of the body structure.")
    image: Optional[list[Attachment]] = Field(default=None, description="Image or images used to identify a location.")
    patient: Reference = Field(default=..., description="The person to which the body site belongs.")
