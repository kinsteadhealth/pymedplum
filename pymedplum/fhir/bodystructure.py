...
class BodyStructure(MedplumFHIRBase):
    ...
    resource_type: Literal["BodyStructure"] = Field(
        default="BodyStructure", alias="resourceType"
    )
    ...
    active: Optional[bool] = Field(
        default=None, description="Whether this body site is in active use."
    )
    ...
    location_qualifier: Optional[list[CodeableConcept]] = Field(
        default=None,
    ...
    patient: Reference = Field(
        default=..., description="The person to which the body site belongs."
    )
