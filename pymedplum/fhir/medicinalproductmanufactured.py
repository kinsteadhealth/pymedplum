...
class MedicinalProductManufactured(MedplumFHIRBase):
    ...
    resource_type: Literal["MedicinalProductManufactured"] = Field(
        default="MedicinalProductManufactured", alias="resourceType"
    )
    ...
    unit_of_presentation: Optional[CodeableConcept] = Field(
        default=None,
        alias="unitOfPresentation",
        description="The &ldquo;real world&rdquo; units in which the quantity of the manufactured item is described.",
    )
    ...
    ingredient: Optional[list[Reference]] = Field(
        default=None, description="Ingredient."
    )
