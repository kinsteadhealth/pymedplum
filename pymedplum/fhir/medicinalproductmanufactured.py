...
class MedicinalProductManufactured(MedplumFHIRBase):
    """The manufactured item as contained in the packaged medicinal product."""

    resource_type: Literal["MedicinalProductManufactured"] = Field(
    ...
    manufactured_dose_form: CodeableConcept = Field(default=..., alias="manufacturedDoseForm", description="Dose form as manufactured and before any transformation into the pharmaceutical product.")
    unit_of_presentation: Optional[CodeableConcept] = Field(default=None, alias="unitOfPresentation", description="The &ldquo;real world&rdquo; units in which the quantity of the manufactured item is described.")
    quantity: Quantity = Field(default=..., description="The quantity or &quot;count number&quot; of the manufactured item.")
    manufacturer: Optional[list[Reference]] = Field(default=None, description="Manufacturer of the item (Note that this should be named &quot;manufacturer&quot; but it currently causes technical issues).")
...
if not TYPE_CHECKING:
    ...
    register_model("MedicinalProductManufactured", MedicinalProductManufactured)
