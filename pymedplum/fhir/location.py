...
class Location(MedplumFHIRBase):
    ...
    status: Optional[Literal["active", "suspended", "inactive"]] = Field(
        default=None,
    ...
    operational_status: Optional[Coding] = Field(
        default=None,
    ...
    mode: Optional[Literal["instance", "kind"]] = Field(
        default=None,
    ...
    hours_of_operation: Optional[list[LocationHoursOfOperation]] = Field(
        default=None,
...
class LocationPosition(MedplumFHIRBase):
    ...
    longitude: Union[int, float] = Field(
        default=...,
    ...
    latitude: Union[int, float] = Field(
        default=...,
    ...
    altitude: Optional[Union[int, float]] = Field(
        default=None,
