...
class Claim(MedplumFHIRBase):
    ...
    related: list[ClaimRelated] | None = Field(
        default=None,
    ...
    item: list[ClaimItem] | None = Field(
        default=None,
...
class ClaimItem(MedplumFHIRBase):
    ...
    detail: list[ClaimItemDetail] | None = Field(
        default=None,
...
class ClaimItemDetail(MedplumFHIRBase):
    ...
    sub_detail: list[ClaimItemDetailSubDetail] | None = Field(
        default=None,
        alias="subDetail",
        description="A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.",
    )
