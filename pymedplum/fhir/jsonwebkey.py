...
class JsonWebKey(MedplumFHIRBase):
    ...
    key_ops: Optional[list[str]] = Field(
        default=None,
    ...
    dp: Optional[str] = Field(
        default=None, description="The first factor CRT exponent."
    )
    dq: Optional[str] = Field(
        default=None, description="The second factor CRT exponent."
    )
