...
if TYPE_CHECKING:
    ...
    from pymedplum.fhir.substanceamount import SubstanceAmount
...
class SubstancePolymer(MedplumFHIRBase):
    ...
    geometry: CodeableConcept | None = Field(default=None, description="Todo.")
    copolymer_connectivity: list[CodeableConcept] | None = Field(
        default=None, alias="copolymerConnectivity", description="Todo."
    )
    modification: list[str] | None = Field(default=None, description="Todo.")
    monomer_set: list[SubstancePolymerMonomerSet] | None = Field(
        default=None, alias="monomerSet", description="Todo."
    )
    repeat: list[SubstancePolymerRepeat] | None = Field(
...
class SubstancePolymerMonomerSet(MedplumFHIRBase):
    ...
    starting_material: list[SubstancePolymerMonomerSetStartingMaterial] | None = Field(
        default=None, alias="startingMaterial", description="Todo."
    )
...
class SubstancePolymerMonomerSetStartingMaterial(MedplumFHIRBase):
    ...
    material: CodeableConcept | None = Field(default=None, description="Todo.")
    ...
    amount: SubstanceAmount | None = Field(default=None, description="Todo.")
...
class SubstancePolymerRepeat(MedplumFHIRBase):
    ...
    number_of_units: int | float | None = Field(
    ...
    repeat_unit: list[SubstancePolymerRepeatRepeatUnit] | None = Field(
...
class SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation(MedplumFHIRBase):
    ...
    degree: CodeableConcept | None = Field(default=None, description="Todo.")
    amount: SubstanceAmount | None = Field(default=None, description="Todo.")
...
class SubstancePolymerRepeatRepeatUnitStructuralRepresentation(MedplumFHIRBase):
    ...
    type: CodeableConcept | None = Field(default=None, description="Todo.")
    representation: str | None = Field(default=None, description="Todo.")
    attachment: Attachment | None = Field(default=None, description="Todo.")
