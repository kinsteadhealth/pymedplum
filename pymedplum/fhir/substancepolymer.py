...
class SubstancePolymer(MedplumFHIRBase):
    ...
    class_: Optional[CodeableConcept] = Field(default=None, alias="class", description="Todo.")
    geometry: Optional[CodeableConcept] = Field(default=None, description="Todo.")
    copolymer_connectivity: Optional[list[CodeableConcept]] = Field(default=None, alias="copolymerConnectivity", description="Todo.")
    modification: Optional[list[str]] = Field(default=None, description="Todo.")
    monomer_set: Optional[list[SubstancePolymerMonomerSet]] = Field(default=None, alias="monomerSet", description="Todo.")
    repeat: Optional[list[SubstancePolymerRepeat]] = Field(default=None, description="Todo.")
...
class SubstancePolymerMonomerSet(MedplumFHIRBase):
    ...
    ratio_type: Optional[CodeableConcept] = Field(default=None, alias="ratioType", description="Todo.")
    starting_material: Optional[list[SubstancePolymerMonomerSetStartingMaterial]] = Field(default=None, alias="startingMaterial", description="Todo.")
...
class SubstancePolymerMonomerSetStartingMaterial(MedplumFHIRBase):
    ...
    is_defining: Optional[bool] = Field(default=None, alias="isDefining", description="Todo.")
...
class SubstancePolymerRepeat(MedplumFHIRBase):
    ...
    extension: Optional[list[Extension]] = Field(default=None, description="May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.")
    modifier_extension: Optional[list[Extension]] = Field(default=None, alias="modifierExtension", description="May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).")
    number_of_units: Optional[Union[int, float]] = Field(default=None, alias="numberOfUnits", description="Todo.")
    average_molecular_formula: Optional[str] = Field(default=None, alias="averageMolecularFormula", description="Todo.")
    repeat_unit_amount_type: Optional[CodeableConcept] = Field(default=None, alias="repeatUnitAmountType", description="Todo.")
    repeat_unit: Optional[list[SubstancePolymerRepeatRepeatUnit]] = Field(default=None, alias="repeatUnit", description="Todo.")
...
class SubstancePolymerRepeatRepeatUnit(MedplumFHIRBase):
    ...
    extension: Optional[list[Extension]] = Field(default=None, description="May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.")
    modifier_extension: Optional[list[Extension]] = Field(default=None, alias="modifierExtension", description="May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).")
    orientation_of_polymerisation: Optional[CodeableConcept] = Field(default=None, alias="orientationOfPolymerisation", description="Todo.")
    repeat_unit: Optional[str] = Field(default=None, alias="repeatUnit", description="Todo.")
    amount: Optional[SubstanceAmount] = Field(default=None, description="Todo.")
    degree_of_polymerisation: Optional[list[SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation]] = Field(default=None, alias="degreeOfPolymerisation", description="Todo.")
    structural_representation: Optional[list[SubstancePolymerRepeatRepeatUnitStructuralRepresentation]] = Field(default=None, alias="structuralRepresentation", description="Todo.")
...
if not TYPE_CHECKING:
    ...
    register_model("SubstancePolymerMonomerSetStartingMaterial", SubstancePolymerMonomerSetStartingMaterial)
    ...
    register_model("SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation", SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation)
    register_model("SubstancePolymerRepeatRepeatUnitStructuralRepresentation", SubstancePolymerRepeatRepeatUnitStructuralRepresentation)
