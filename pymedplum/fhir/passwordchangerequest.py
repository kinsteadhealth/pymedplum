...
class PasswordChangeRequest(MedplumFHIRBase):
    ...
    type: Optional[Literal['invite', 'reset']] = Field(default=None, description="The type of password change request (invite or reset).")
    user: Reference = Field(default=..., description="The user requesting the password change.")
...
if not TYPE_CHECKING:
    ...
    register_model("PasswordChangeRequest", PasswordChangeRequest)
