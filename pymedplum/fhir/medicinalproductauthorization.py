...
class MedicinalProductAuthorization(MedplumFHIRBase):
    ...
    restore_date: Optional[str] = Field(
        default=None,
        alias="restoreDate",
    ...
    data_exclusivity_period: Optional[Period] = Field(
        default=None,
    ...
    date_of_first_authorization: Optional[str] = Field(
        default=None,
    ...
    international_birth_date: Optional[str] = Field(
        default=None,
    ...
    legal_basis: Optional[CodeableConcept] = Field(
        default=None,
        alias="legalBasis",
        description="The legal framework against which this authorization is granted.",
    )
    jurisdictional_authorization: Optional[
...
class MedicinalProductAuthorizationProcedure(MedplumFHIRBase):
    ...
    date_period: Optional[Period] = Field(
        default=None, alias="datePeriod", description="Date of procedure."
    )
    date_date_time: Optional[str] = Field(
