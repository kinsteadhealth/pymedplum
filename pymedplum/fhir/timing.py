...
class TimingRepeat(MedplumFHIRBase):
    ...
    bounds_duration: Optional[Duration] = Field(
        default=None,
        alias="boundsDuration",
        description="Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule.",
    )
    bounds_range: Optional[Range] = Field(
        default=None,
        alias="boundsRange",
        description="Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule.",
    )
    bounds_period: Optional[Period] = Field(
        default=None,
        alias="boundsPeriod",
        description="Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule.",
    )
    ...
    count_max: Optional[Union[int, float]] = Field(
        default=None,
        alias="countMax",
    ...
    duration_max: Optional[Union[int, float]] = Field(
        default=None,
        alias="durationMax",
    ...
    duration_unit: Optional[Literal["s", "min", "h", "d", "wk", "mo", "a"]] = Field(
        default=None,
        alias="durationUnit",
        description="The units of time for the duration, in UCUM units.",
    )
    frequency: Optional[Union[int, float]] = Field(
        default=None,
    ...
    frequency_max: Optional[Union[int, float]] = Field(
        default=None,
        alias="frequencyMax",
    ...
    period: Optional[Union[int, float]] = Field(
        default=None,
    ...
    period_max: Optional[Union[int, float]] = Field(
        default=None,
        alias="periodMax",
    ...
    period_unit: Optional[Literal["s", "min", "h", "d", "wk", "mo", "a"]] = Field(
        default=None,
        alias="periodUnit",
    ...
    offset: Optional[Union[int, float]] = Field(
        default=None,
