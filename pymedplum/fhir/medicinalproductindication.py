...
class MedicinalProductIndication(MedplumFHIRBase):
    ...
    intended_effect: Optional[CodeableConcept] = Field(
        default=None,
    ...
    other_therapy: Optional[list[MedicinalProductIndicationOtherTherapy]] = Field(
        default=None,
        alias="otherTherapy",
    ...
    undesirable_effect: Optional[list[Reference]] = Field(
        default=None,
