...
class MedicinalProductIndication(MedplumFHIRBase):
    ...
    disease_symptom_procedure: Optional[CodeableConcept] = Field(default=None, alias="diseaseSymptomProcedure", description="The disease, symptom or procedure that is the indication for treatment.")
    disease_status: Optional[CodeableConcept] = Field(default=None, alias="diseaseStatus", description="The status of the disease or symptom for which the indication applies.")
    comorbidity: Optional[list[CodeableConcept]] = Field(default=None, description="Comorbidity (concurrent condition) or co-infection as part of the indication.")
    intended_effect: Optional[CodeableConcept] = Field(default=None, alias="intendedEffect", description="The intended effect, aim or strategy to be achieved by the indication.")
    duration: Optional[Quantity] = Field(default=None, description="Timing or duration information as part of the indication.")
    other_therapy: Optional[list[MedicinalProductIndicationOtherTherapy]] = Field(default=None, alias="otherTherapy", description="Information about the use of the medicinal product in relation to other therapies described as part of the indication.")
    undesirable_effect: Optional[list[Reference]] = Field(default=None, alias="undesirableEffect", description="Describe the undesirable effects of the medicinal product.")
...
if not TYPE_CHECKING:
    ...
    register_model("MedicinalProductIndication", MedicinalProductIndication)
    register_model("MedicinalProductIndicationOtherTherapy", MedicinalProductIndicationOtherTherapy)
