...
class AccessPolicy(MedplumFHIRBase):
    ...
    resource_type: Literal["AccessPolicy"] = Field(
        default="AccessPolicy", alias="resourceType"
    )
    ...
    name: Optional[str] = Field(
        default=None, description="A name associated with the AccessPolicy."
    )
    ...
    compartment: Optional[Reference] = Field(
        default=None,
    ...
    resource: Optional[list[AccessPolicyResource]] = Field(
        default=None, description="Access details for a resource type."
    )
    ip_access_rule: Optional[list[AccessPolicyIpAccessRule]] = Field(
        default=None,
        alias="ipAccessRule",
