...
class AccessPolicy(MedplumFHIRBase):
    ...
    compartment: Reference | None = Field(
        default=None,
    ...
    resource: list[AccessPolicyResource] | None = Field(
        default=None, description="Access details for a resource type."
    )
    ip_access_rule: list[AccessPolicyIpAccessRule] | None = Field(
        default=None,
        alias="ipAccessRule",
