...
class UserConfiguration(MedplumFHIRBase):
    ...
    menu: list[UserConfigurationMenu] | None = Field(
        default=None, description="Optional menu of shortcuts to URLs."
    )
    search: list[UserConfigurationSearch] | None = Field(
        default=None, description="Shortcut links to URLs."
    )
    option: list[UserConfigurationOption] | None = Field(
        default=None,
...
class UserConfigurationMenu(MedplumFHIRBase):
    ...
    link: list[UserConfigurationMenuLink] | None = Field(
        default=None, description="Shortcut links to URLs."
    )
