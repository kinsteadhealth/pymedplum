...
class UserConfiguration(MedplumFHIRBase):
    ...
    name: Optional[str] = Field(default=None, description="A name associated with the UserConfiguration.")
    menu: Optional[List[UserConfigurationMenu]] = Field(default=None, description="Optional menu of shortcuts to URLs.")
    search: Optional[List[UserConfigurationSearch]] = Field(default=None, description="Shortcut links to URLs.")
    option: Optional[List[UserConfigurationOption]] = Field(default=None, description="User options that control the display of the application.")
...
class UserConfigurationMenu(MedplumFHIRBase):
    ...
    link: Optional[List[UserConfigurationMenuLink]] = Field(default=None, description="Shortcut links to URLs.")
...
class UserConfigurationOption(MedplumFHIRBase):
    ...
    value_boolean: Optional[bool] = Field(default=None, alias="valueBoolean", description="Value of option - must be one of a constrained set of the data types (see [Extensibility](extensibility.html) for a list).")
    value_code: Optional[str] = Field(default=None, alias="valueCode", description="Value of option - must be one of a constrained set of the data types (see [Extensibility](extensibility.html) for a list).")
    value_decimal: Optional[Union[int, float]] = Field(default=None, alias="valueDecimal", description="Value of option - must be one of a constrained set of the data types (see [Extensibility](extensibility.html) for a list).")
    value_integer: Optional[Union[int, float]] = Field(default=None, alias="valueInteger", description="Value of option - must be one of a constrained set of the data types (see [Extensibility](extensibility.html) for a list).")
    value_string: Optional[str] = Field(default=None, alias="valueString", description="Value of option - must be one of a constrained set of the data types (see [Extensibility](extensibility.html) for a list).")
...
class UserConfigurationSearch(MedplumFHIRBase):
    ...
    name: str = Field(default=..., description="The human friendly name of the link.")
    criteria: str = Field(default=..., description="The rules that the server should use to determine which resources to return.")
