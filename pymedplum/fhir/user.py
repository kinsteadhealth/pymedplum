...
class User(MedplumFHIRBase):
    """Representation of a human user of the system."""

    resource_type: Literal["User"] = Field(
        default="User",
        alias="resourceType"
    )
    ...
    identifier: Optional[list[Identifier]] = Field(default=None, description="An identifier for this user.")
    first_name: str = Field(default=..., alias="firstName", description="The first name or given name of the user. This is the value as entered when the user is created. It is used to populate the profile resource.")
    last_name: str = Field(default=..., alias="lastName", description="The last name or family name of the user. This is the value as entered when the user is created. It is used to populate the profile resource.")
    external_id: Optional[str] = Field(default=None, alias="externalId")
    email: Optional[str] = Field(default=None, description="The email address that uniquely identifies the user.")
    email_verified: Optional[bool] = Field(default=None, alias="emailVerified", description="Whether the system has verified that the user has access to the email address.")
    admin: Optional[bool] = Field(default=None)
    password_hash: Optional[str] = Field(default=None, alias="passwordHash", description="Encrypted hash of the user's password.")
    mfa_secret: Optional[str] = Field(default=None, alias="mfaSecret", description="Shared secret for MFA authenticator applications.")
    mfa_enrolled: Optional[bool] = Field(default=None, alias="mfaEnrolled", description="Whether the user has completed MFA enrollment.")
    project: Optional[Reference] = Field(default=None, description="Optional project if the user only exists for the project. This is used for the project-specific user database.")
