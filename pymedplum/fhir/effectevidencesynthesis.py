...
class EffectEvidenceSynthesis(MedplumFHIRBase):
    ...
    url: Optional[str] = Field(default=None, description="An absolute URI that is used to identify this effect evidence synthesis when it is referenced in a specification, model, design or an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a literal address at which at which an authoritative instance of this effect evidence synthesis is (or will be) published. This URL can be the target of a canonical reference. It SHALL remain the same when the effect evidence synthesis is stored on different servers.")
    identifier: Optional[list[Identifier]] = Field(default=None, description="A formal identifier that is used to identify this effect evidence synthesis when it is represented in other formats, or referenced in a specification, model, design or an instance.")
    version: Optional[str] = Field(default=None, description="The identifier that is used to identify this version of the effect evidence synthesis when it is referenced in a specification, model, design or instance. This is an arbitrary value managed by the effect evidence synthesis author and is not expected to be globally unique. For example, it might be a timestamp (e.g. yyyymmdd) if a managed version is not available. There is also no expectation that versions can be placed in a lexicographical sequence.")
    name: Optional[str] = Field(default=None, description="A natural language name identifying the effect evidence synthesis. This name should be usable as an identifier for the module by machine processing applications such as code generation.")
    title: Optional[str] = Field(default=None, description="A short, descriptive, user-friendly title for the effect evidence synthesis.")
    status: Literal['draft', 'active', 'retired', 'unknown'] = Field(default=..., description="The status of this effect evidence synthesis. Enables tracking the life-cycle of the content.")
    ...
    publisher: Optional[str] = Field(default=None, description="The name of the organization or individual that published the effect evidence synthesis.")
    ...
    description: Optional[str] = Field(default=None, description="A free text natural language description of the effect evidence synthesis from a consumer's perspective.")
    ...
    use_context: Optional[list[UsageContext]] = Field(default=None, alias="useContext", description="The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate effect evidence synthesis instances.")
    jurisdiction: Optional[list[CodeableConcept]] = Field(default=None, description="A legal or geographic region in which the effect evidence synthesis is intended to be used.")
    copyright: Optional[str] = Field(default=None, description="A copyright statement relating to the effect evidence synthesis and/or its contents. Copyright statements are generally legal restrictions on the use and publishing of the effect evidence synthesis.")
    ...
    effective_period: Optional[Period] = Field(default=None, alias="effectivePeriod", description="The period during which the effect evidence synthesis content was or is planned to be in active use.")
    topic: Optional[list[CodeableConcept]] = Field(default=None, description="Descriptive topics related to the content of the EffectEvidenceSynthesis. Topics provide a high-level categorization grouping types of EffectEvidenceSynthesiss that can be useful for filtering and searching.")
    ...
    exposure: Reference = Field(default=..., description="A reference to a EvidenceVariable resource that defines the exposure for the research.")
    exposure_alternative: Reference = Field(default=..., alias="exposureAlternative", description="A reference to a EvidenceVariable resource that defines the comparison exposure for the research.")
    ...
    sample_size: Optional[EffectEvidenceSynthesisSampleSize] = Field(default=None, alias="sampleSize", description="A description of the size of the sample involved in the synthesis.")
    results_by_exposure: Optional[list[EffectEvidenceSynthesisResultsByExposure]] = Field(default=None, alias="resultsByExposure", description="A description of the results for each exposure considered in the effect estimate.")
    effect_estimate: Optional[list[EffectEvidenceSynthesisEffectEstimate]] = Field(default=None, alias="effectEstimate", description="The estimated effect of the exposure variant.")
    certainty: Optional[list[EffectEvidenceSynthesisCertainty]] = Field(default=None, description="A description of the certainty of the effect estimate.")
...
class EffectEvidenceSynthesisCertainty(MedplumFHIRBase):
    ...
    note: Optional[list[Annotation]] = Field(default=None, description="A human-readable string to clarify or explain concepts about the resource.")
    certainty_subcomponent: Optional[list[EffectEvidenceSynthesisCertaintyCertaintySubcomponent]] = Field(default=None, alias="certaintySubcomponent", description="A description of a component of the overall certainty.")
...
class EffectEvidenceSynthesisEffectEstimate(MedplumFHIRBase):
    ...
    extension: Optional[list[Extension]] = Field(default=None, description="May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.")
    modifier_extension: Optional[list[Extension]] = Field(default=None, alias="modifierExtension", description="May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).")
    description: Optional[str] = Field(default=None, description="Human-readable summary of effect estimate.")
    type: Optional[CodeableConcept] = Field(default=None, description="Examples include relative risk and mean difference.")
    variant_state: Optional[CodeableConcept] = Field(default=None, alias="variantState", description="Used to define variant exposure states such as low-risk state.")
    value: Optional[Union[int, float]] = Field(default=None, description="The point estimate of the effect estimate.")
    ...
    precision_estimate: Optional[list[EffectEvidenceSynthesisEffectEstimatePrecisionEstimate]] = Field(default=None, alias="precisionEstimate", description="A description of the precision of the estimate for the effect.")
...
class EffectEvidenceSynthesisResultsByExposure(MedplumFHIRBase):
    ...
    extension: Optional[list[Extension]] = Field(default=None, description="May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.")
    modifier_extension: Optional[list[Extension]] = Field(default=None, alias="modifierExtension", description="May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).")
    description: Optional[str] = Field(default=None, description="Human-readable summary of results by exposure state.")
    exposure_state: Optional[Literal['exposure', 'exposure-alternative']] = Field(default=None, alias="exposureState", description="Whether these results are for the exposure state or alternative exposure state.")
    variant_state: Optional[CodeableConcept] = Field(default=None, alias="variantState", description="Used to define variant exposure states such as low-risk state.")
    risk_evidence_synthesis: Reference = Field(default=..., alias="riskEvidenceSynthesis", description="Reference to a RiskEvidenceSynthesis resource.")
...
if not TYPE_CHECKING:
    ...
    register_model("EffectEvidenceSynthesisCertaintyCertaintySubcomponent", EffectEvidenceSynthesisCertaintyCertaintySubcomponent)
    register_model("EffectEvidenceSynthesisEffectEstimate", EffectEvidenceSynthesisEffectEstimate)
    register_model("EffectEvidenceSynthesisEffectEstimatePrecisionEstimate", EffectEvidenceSynthesisEffectEstimatePrecisionEstimate)
    register_model("EffectEvidenceSynthesisResultsByExposure", EffectEvidenceSynthesisResultsByExposure)
    register_model("EffectEvidenceSynthesisSampleSize", EffectEvidenceSynthesisSampleSize)
