...
class EffectEvidenceSynthesis(MedplumFHIRBase):
    ...
    results_by_exposure: list[EffectEvidenceSynthesisResultsByExposure] | None = Field(
        default=None,
        alias="resultsByExposure",
        description="A description of the results for each exposure considered in the effect estimate.",
    )
    effect_estimate: list[EffectEvidenceSynthesisEffectEstimate] | None = Field(
        default=None,
        alias="effectEstimate",
        description="The estimated effect of the exposure variant.",
    )
    certainty: list[EffectEvidenceSynthesisCertainty] | None = Field(
        default=None,
