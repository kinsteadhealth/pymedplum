...
class Person(MedplumFHIRBase):
    ...
    resource_type: Literal["Person"] = Field(
        default="Person",
        alias="resourceType"
    )
    ...
    gender: Optional[Literal['male', 'female', 'other', 'unknown']] = Field(default=None, description="Administrative Gender.")
    birth_date: Optional[str] = Field(default=None, alias="birthDate", description="The birth date for the person.")
    address: Optional[List[Address]] = Field(default=None, description="One or more addresses for the person.")
    photo: Optional[Attachment] = Field(default=None, description="An image that can be displayed as a thumbnail of the person to enhance the identification of the individual.")
    managing_organization: Optional[Reference] = Field(default=None, alias="managingOrganization", description="The organization that is the custodian of the person record.")
    active: Optional[bool] = Field(default=None, description="Whether this person's record is in active use.")
    link: Optional[List[PersonLink]] = Field(default=None, description="Link to a resource that concerns the same actual person.")
...
class PersonLink(MedplumFHIRBase):
    ...
    target: Reference = Field(default=..., description="The resource to which this actual person is associated.")
    assurance: Optional[Literal['level1', 'level2', 'level3', 'level4']] = Field(default=None, description="Level of assurance that this link is associated with the target resource.")
