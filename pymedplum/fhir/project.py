...
class Project(MedplumFHIRBase):
    ...
    super_admin: Optional[bool] = Field(
        default=None,
        alias="superAdmin",
    ...
    check_references_on_write: Optional[bool] = Field(
        default=None,
    ...
    system_setting: Optional[list[ProjectSetting]] = Field(
        default=None,
        alias="systemSetting",
    ...
    system_secret: Optional[list[ProjectSetting]] = Field(
        default=None,
        alias="systemSecret",
