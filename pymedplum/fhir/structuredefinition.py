...
if TYPE_CHECKING:
    ...
    from pymedplum.fhir.elementdefinition import ElementDefinition
...
class StructureDefinition(MedplumFHIRBase):
    ...
    keyword: list[Coding] | None = Field(
        default=None,
    ...
    mapping: list[StructureDefinitionMapping] | None = Field(
        default=None,
