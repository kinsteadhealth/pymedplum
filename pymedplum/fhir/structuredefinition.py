...
class StructureDefinition(MedplumFHIRBase):
    ...
    resource_type: Literal["StructureDefinition"] = Field(
        default="StructureDefinition", alias="resourceType"
    )
    ...
    context_invariant: Optional[List[str]] = Field(
        default=None,
    ...
    base_definition: Optional[str] = Field(
        default=None,
    ...
    derivation: Optional[Literal["specialization", "constraint"]] = Field(
