...
class ResearchStudy(MedplumFHIRBase):
    ...
    primary_purpose_type: Optional[CodeableConcept] = Field(
        default=None,
    ...
    study_design: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="studyDesign",
    ...
    principal_investigator: Optional[Reference] = Field(
        default=None,
    ...
    reason_stopped: Optional[CodeableConcept] = Field(
        default=None,
        alias="reasonStopped",
    ...
    associated_party: Optional[list[ResearchStudyAssociatedParty]] = Field(
        default=None,
        alias="associatedParty",
        description="Sponsors, collaborators, and other parties.",
    )
    progress_status: Optional[list[ResearchStudyProgressStatus]] = Field(
        default=None,
        alias="progressStatus",
        description="Status of study with time for that status.",
    )
    why_stopped: Optional[CodeableConcept] = Field(
        default=None,
        alias="whyStopped",
        description="A description and/or code explaining the premature termination of the study.",
    )
    ...
    comparison_group: Optional[list[ResearchStudyComparisonGroup]] = Field(
        default=None,
    ...
    outcome_measure: Optional[list[ResearchStudyOutcomeMeasure]] = Field(
        default=None,
...
class ResearchStudyRecruitment(MedplumFHIRBase):
    ...
    target_number: Optional[Union[int, float]] = Field(
        default=None,
        alias="targetNumber",
        description="Estimated total number of participants to be enrolled.",
    )
    actual_number: Optional[Union[int, float]] = Field(
        default=None,
        alias="actualNumber",
    ...
    actual_group: Optional[Reference] = Field(
        default=None,
        alias="actualGroup",
