...
class AdverseEvent(MedplumFHIRBase):
    ...
    resulting_condition: Optional[list[Reference]] = Field(
        default=None,
    ...
    suspect_entity: Optional[list[AdverseEventSuspectEntity]] = Field(
        default=None,
        alias="suspectEntity",
        description="Describes the entity that is suspected to have caused the adverse event.",
    )
    subject_medical_history: Optional[list[Union[Reference]]] = Field(
        default=None,
        alias="subjectMedicalHistory",
        description="AdverseEvent.subjectMedicalHistory.",
    )
    reference_document: Optional[list[Reference]] = Field(
        default=None,
...
class AdverseEventSuspectEntityCausality(MedplumFHIRBase):
    ...
    product_relatedness: Optional[str] = Field(
        default=None,
