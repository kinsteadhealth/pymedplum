...
class AdverseEvent(MedplumFHIRBase):
    ...
    resource_type: Literal["AdverseEvent"] = Field(
        default="AdverseEvent", alias="resourceType"
    )
    ...
    subject: Reference = Field(
        default=..., description="This subject or group impacted by the event."
    )
    ...
    resulting_condition: list[Reference] | None = Field(
        default=None,
...
class AdverseEventSuspectEntity(MedplumFHIRBase):
    ...
    causality: list[AdverseEventSuspectEntityCausality] | None = Field(
        default=None, description="Information on the possible cause of the event."
    )
