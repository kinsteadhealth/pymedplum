...
class SubstanceProtein(MedplumFHIRBase):
    ...
    sequence_type: Optional[CodeableConcept] = Field(default=None, alias="sequenceType", description="The SubstanceProtein descriptive elements will only be used when a complete or partial amino acid sequence is available or derivable from a nucleic acid sequence.")
    number_of_subunits: Optional[Union[int, float]] = Field(default=None, alias="numberOfSubunits", description="Number of linear sequences of amino acids linked through peptide bonds. The number of subunits constituting the SubstanceProtein shall be described. It is possible that the number of subunits can be variable.")
    disulfide_linkage: Optional[List[str]] = Field(default=None, alias="disulfideLinkage", description="The disulphide bond between two cysteine residues either on the same subunit or on two different subunits shall be described. The position of the disulfide bonds in the SubstanceProtein shall be listed in increasing order of subunit number and position within subunit followed by the abbreviation of the amino acids involved. The disulfide linkage positions shall actually contain the amino acid Cysteine at the respective positions.")
    subunit: Optional[List[SubstanceProteinSubunit]] = Field(default=None, description="This subclause refers to the description of each subunit constituting the SubstanceProtein. A subunit is a linear sequence of amino acids linked through peptide bonds. The Subunit information shall be provided when the finished SubstanceProtein is a complex of multiple sequences; subunits are not used to delineate domains within a single sequence. Subunits are listed in order of decreasing length; sequences of the same length will be ordered by decreasing molecular weight; subunits that have identical sequences will be repeated multiple times.")
...
class SubstanceProteinSubunit(MedplumFHIRBase):
    ...
    subunit: Optional[Union[int, float]] = Field(default=None, description="Index of primary sequences of amino acids linked through peptide bonds in order of decreasing length. Sequences of the same length will be ordered by molecular weight. Subunits that have identical sequences will be repeated and have sequential subscripts.")
    sequence: Optional[str] = Field(default=None, description="The sequence information shall be provided enumerating the amino acids from N- to C-terminal end using standard single-letter amino acid codes. Uppercase shall be used for L-amino acids and lowercase for D-amino acids. Transcribed SubstanceProteins will always be described using the translated sequence; for synthetic peptide containing amino acids that are not represented with a single letter code an X should be used within the sequence. The modified amino acids will be distinguished by their position in the sequence.")
    length: Optional[Union[int, float]] = Field(default=None, description="Length of linear sequences of amino acids contained in the subunit.")
    sequence_attachment: Optional[Attachment] = Field(default=None, alias="sequenceAttachment", description="The sequence information shall be provided enumerating the amino acids from N- to C-terminal end using standard single-letter amino acid codes. Uppercase shall be used for L-amino acids and lowercase for D-amino acids. Transcribed SubstanceProteins will always be described using the translated sequence; for synthetic peptide containing amino acids that are not represented with a single letter code an X should be used within the sequence. The modified amino acids will be distinguished by their position in the sequence.")
    n_terminal_modification_id: Optional[Identifier] = Field(default=None, alias="nTerminalModificationId", description="Unique identifier for molecular fragment modification based on the ISO 11238 Substance ID.")
    n_terminal_modification: Optional[str] = Field(default=None, alias="nTerminalModification", description="The name of the fragment modified at the N-terminal of the SubstanceProtein shall be specified.")
    c_terminal_modification_id: Optional[Identifier] = Field(default=None, alias="cTerminalModificationId", description="Unique identifier for molecular fragment modification based on the ISO 11238 Substance ID.")
    c_terminal_modification: Optional[str] = Field(default=None, alias="cTerminalModification", description="The modification at the C-terminal shall be specified.")
...
if not TYPE_CHECKING:
    ...
    register_model("SubstanceProtein", SubstanceProtein)
    register_model("SubstanceProteinSubunit", SubstanceProteinSubunit)
