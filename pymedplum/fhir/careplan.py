...
class CarePlan(MedplumFHIRBase):
    ...
    care_team: list[Reference] | None = Field(
        default=None,
        alias="careTeam",
...
class CarePlanActivity(MedplumFHIRBase):
    ...
    outcome_codeable_concept: list[CodeableConcept] | None = Field(
        default=None,
    ...
    progress: list[Annotation] | None = Field(
        default=None,
