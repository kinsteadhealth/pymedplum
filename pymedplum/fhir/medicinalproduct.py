...
class MedicinalProduct(MedplumFHIRBase):
    ...
    combined_pharmaceutical_dose_form: Optional[CodeableConcept] = Field(
        default=None,
    ...
    clinical_trial: Optional[List[Reference]] = Field(
        default=None,
        alias="clinicalTrial",
    ...
    special_designation: Optional[List[MedicinalProductSpecialDesignation]] = Field(
        default=None,
...
class MedicinalProductManufacturingBusinessOperation(MedplumFHIRBase):
    ...
    operation_type: Optional[CodeableConcept] = Field(
        default=None,
        alias="operationType",
        description="The type of manufacturing operation.",
    )
    authorisation_reference_number: Optional[Identifier] = Field(
        default=None,
    ...
    confidentiality_indicator: Optional[CodeableConcept] = Field(
        default=None,
...
class MedicinalProductName(MedplumFHIRBase):
    ...
    name_part: Optional[List[MedicinalProductNameNamePart]] = Field(
        default=None,
        alias="namePart",
        description="Coding words or phrases of the name.",
    )
    country_language: Optional[List[MedicinalProductNameCountryLanguage]] = Field(
        default=None,
...
class MedicinalProductSpecialDesignation(MedplumFHIRBase):
    ...
    intended_use: Optional[CodeableConcept] = Field(
        default=None,
        alias="intendedUse",
