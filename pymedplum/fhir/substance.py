...
class Substance(MedplumFHIRBase):
    ...
    resource_type: Literal["Substance"] = Field(
        default="Substance", alias="resourceType"
    )
    ...
    instance: list[SubstanceInstance] | None = Field(
        default=None,
    ...
    ingredient: list[SubstanceIngredient] | None = Field(
...
class SubstanceInstance(MedplumFHIRBase):
    ...
    quantity: Quantity | None = Field(
        default=None, description="The amount of the substance."
    )
