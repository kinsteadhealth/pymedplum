...
class ImagingStudy(MedplumFHIRBase):
    ...
    number_of_series: Optional[Union[int, float]] = Field(
        default=None,
    ...
    number_of_instances: Optional[Union[int, float]] = Field(
        default=None,
    ...
    procedure_code: Optional[List[CodeableConcept]] = Field(
        default=None,
        alias="procedureCode",
...
class ImagingStudySeries(MedplumFHIRBase):
    ...
    body_site: Optional[Coding] = Field(
        default=None,
        alias="bodySite",
