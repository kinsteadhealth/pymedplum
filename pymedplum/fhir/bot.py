...
class Bot(MedplumFHIRBase):
    ...
    runtime_version: Optional[Literal["awslambda", "vmcontext"]] = Field(
        default=None,
    ...
    cron_timing: Optional[Timing] = Field(
        default=None,
        alias="cronTiming",
    ...
    run_as_user: Optional[bool] = Field(
        default=None,
        alias="runAsUser",
        description="Optional flag to indicate that the bot should be run as the user.",
    )
    audit_event_trigger: Optional[
        Literal["always", "never", "on-error", "on-output"]
    ] = Field(
        default=None,
    ...
    audit_event_destination: Optional[List[Literal["log", "resource"]]] = Field(
        default=None,
    ...
    source_code: Optional[Attachment] = Field(
        default=None,
        alias="sourceCode",
        description="Bot logic in original source code form written by developers.",
    )
    executable_code: Optional[Attachment] = Field(
        default=None,
