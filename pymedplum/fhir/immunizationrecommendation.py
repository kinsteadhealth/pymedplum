...
class ImmunizationRecommendation(MedplumFHIRBase):
    ...
    resource_type: Literal["ImmunizationRecommendation"] = Field(
        default="ImmunizationRecommendation", alias="resourceType"
    )
    ...
    patient: Reference = Field(
        default=..., description="The patient the recommendation(s) are for."
    )
    date: str = Field(
        default=...,
    ...
    recommendation: List[ImmunizationRecommendationRecommendation] = Field(
        default=..., description="Vaccine administration recommendations."
    )
...
class ImmunizationRecommendationRecommendation(MedplumFHIRBase):
    ...
    vaccine_code: Optional[List[CodeableConcept]] = Field(
        default=None,
        alias="vaccineCode",
        description="Vaccine(s) or vaccine group that pertain to the recommendation.",
    )
    target_disease: Optional[CodeableConcept] = Field(
        default=None,
        alias="targetDisease",
        description="The targeted disease for the recommendation.",
    )
    contraindicated_vaccine_code: Optional[List[CodeableConcept]] = Field(
        default=None,
    ...
    supporting_immunization: Optional[List[Reference]] = Field(
        default=None,
    ...
    supporting_patient_information: Optional[List[Reference]] = Field(
        default=None,
