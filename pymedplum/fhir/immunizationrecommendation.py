...
class ImmunizationRecommendationRecommendation(MedplumFHIRBase):
    ...
    vaccine_code: list[CodeableConcept] | None = Field(
        default=None,
        alias="vaccineCode",
    ...
    contraindicated_vaccine_code: list[CodeableConcept] | None = Field(
        default=None,
    ...
    forecast_reason: list[CodeableConcept] | None = Field(
        default=None,
    ...
    supporting_immunization: list[Reference] | None = Field(
        default=None,
    ...
    supporting_patient_information: list[Reference] | None = Field(
        default=None,
