...
class GuidanceResponse(MedplumFHIRBase):
    ...
    resource_type: Literal["GuidanceResponse"] = Field(
        default="GuidanceResponse", alias="resourceType"
    )
    ...
    request_identifier: Optional[Identifier] = Field(
        default=None,
    ...
    evaluation_message: Optional[list[Reference]] = Field(
        default=None,
    ...
    output_parameters: Optional[Reference] = Field(
        default=None,
    ...
    data_requirement: Optional[list[DataRequirement]] = Field(
        default=None,
