...
class DocumentReference(MedplumFHIRBase):
    ...
    relates_to: list[DocumentReferenceRelatesTo] | None = Field(
        default=None,
        alias="relatesTo",
    ...
    security_label: list[CodeableConcept] | None = Field(
        default=None,
        alias="securityLabel",
...
class DocumentReferenceContext(MedplumFHIRBase):
    ...
    event: list[CodeableConcept] | None = Field(
        default=None,
    ...
    related: list[Reference] | None = Field(
        default=None,
