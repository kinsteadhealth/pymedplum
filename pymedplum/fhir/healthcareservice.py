...
class HealthcareService(MedplumFHIRBase):
    ...
    provided_by: Optional[Reference] = Field(
        default=None,
        alias="providedBy",
    ...
    coverage_area: Optional[list[Reference]] = Field(
        default=None,
        alias="coverageArea",
        description="The location(s) that this service is available to (not where the service is provided).",
    )
    service_provision_code: Optional[list[CodeableConcept]] = Field(
        default=None,
    ...
    referral_method: Optional[list[CodeableConcept]] = Field(
        default=None,
    ...
    available_time: Optional[list[HealthcareServiceAvailableTime]] = Field(
        default=None,
        alias="availableTime",
        description="A collection of times that the Service Site is available.",
    )
    not_available: Optional[list[HealthcareServiceNotAvailable]] = Field(
        default=None,
        alias="notAvailable",
