...
class MessageHeader(MedplumFHIRBase):
    ...
    event_coding: Optional[Coding] = Field(default=None, alias="eventCoding", description="Code that identifies the event this message represents and connects it with its definition. Events defined as part of the FHIR specification have the system value &quot;http://terminology.hl7.org/CodeSystem/message-events&quot;. Alternatively uri to the EventDefinition.")
    event_uri: Optional[str] = Field(default=None, alias="eventUri", description="Code that identifies the event this message represents and connects it with its definition. Events defined as part of the FHIR specification have the system value &quot;http://terminology.hl7.org/CodeSystem/message-events&quot;. Alternatively uri to the EventDefinition.")
    destination: Optional[List[MessageHeaderDestination]] = Field(default=None, description="The destination application which the message is intended for.")
    ...
    focus: Optional[List[Reference]] = Field(default=None, description="The actual data of the message - a reference to the root/focus class of the event.")
    definition: Optional[str] = Field(default=None, description="Permanent link to the MessageDefinition for this message.")
...
class MessageHeaderDestination(MedplumFHIRBase):
    ...
    name: Optional[str] = Field(default=None, description="Human-readable name for the target system.")
    target: Optional[Reference] = Field(default=None, description="Identifies the target end system in situations where the initial message transmission is to an intermediary system.")
    endpoint: str = Field(default=..., description="Indicates where the message should be routed to.")
    receiver: Optional[Reference] = Field(default=None, description="Allows data conveyed by a message to be addressed to a particular person or department when routing to a specific application isn't sufficient.")
...
class MessageHeaderResponse(MedplumFHIRBase):
    ...
    extension: Optional[List[Extension]] = Field(default=None, description="May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.")
    modifier_extension: Optional[List[Extension]] = Field(default=None, alias="modifierExtension", description="May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).")
    identifier: str = Field(default=..., description="The MessageHeader.id of the message to which this message is a response.")
    code: Literal['ok', 'transient-error', 'fatal-error'] = Field(default=..., description="Code that identifies the type of response to the message - whether it was successful or not, and whether it should be resent or not.")
    details: Optional[Reference] = Field(default=None, description="Full details of any issues found in the message.")
...
class MessageHeaderSource(MedplumFHIRBase):
    ...
    extension: Optional[List[Extension]] = Field(default=None, description="May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.")
    modifier_extension: Optional[List[Extension]] = Field(default=None, alias="modifierExtension", description="May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).")
    name: Optional[str] = Field(default=None, description="Human-readable name for the source system.")
    software: Optional[str] = Field(default=None, description="May include configuration or other information useful in debugging.")
    version: Optional[str] = Field(default=None, description="Can convey versions of multiple systems in situations where a message passes through multiple hands.")
    contact: Optional[ContactPoint] = Field(default=None, description="An e-mail, phone, website or other contact point to use to resolve issues with message communications.")
    endpoint: str = Field(default=..., description="Identifies the routing target to send acknowledgements to.")
...
if not TYPE_CHECKING:
    ...
    register_model("MessageHeaderResponse", MessageHeaderResponse)
    register_model("MessageHeaderSource", MessageHeaderSource)
