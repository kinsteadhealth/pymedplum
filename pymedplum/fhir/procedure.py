...
class Procedure(MedplumFHIRBase):
    ...
    performed_date_time: Optional[str] = Field(
        default=None,
    ...
    performed_period: Optional[Period] = Field(
        default=None,
    ...
    performed_age: Optional[Age] = Field(
        default=None,
        alias="performedAge",
        description="Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured.",
    )
    performed_range: Optional[Range] = Field(
        default=None,
    ...
    complication_detail: Optional[list[Reference]] = Field(
        default=None,
    ...
    follow_up: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="followUp",
    ...
    focal_device: Optional[list[ProcedureFocalDevice]] = Field(
        default=None,
        alias="focalDevice",
