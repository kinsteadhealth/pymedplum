...
class ResearchSubject(MedplumFHIRBase):
    ...
    resource_type: Literal["ResearchSubject"] = Field(
    ...
    identifier: Optional[List[Identifier]] = Field(default=None, description="Identifiers assigned to this research subject for a study.")
    status: Literal['candidate', 'eligible', 'follow-up', 'ineligible', 'not-registered', 'off-study', 'on-study', 'on-study-intervention', 'on-study-observation', 'pending-on-study', 'potential-candidate', 'screening', 'withdrawn'] = Field(default=..., description="The current state of the subject.")
    period: Optional[Period] = Field(default=None, description="The dates the subject began and ended their participation in the study.")
    study: Reference = Field(default=..., description="Reference to the study the subject is participating in.")
    individual: Reference = Field(default=..., description="The record of the person or animal who is involved in the study.")
    assigned_arm: Optional[str] = Field(default=None, alias="assignedArm", description="The name of the arm in the study the subject is expected to follow as part of this study.")
    actual_arm: Optional[str] = Field(default=None, alias="actualArm", description="The name of the arm in the study the subject actually followed as part of this study.")
    consent: Optional[Reference] = Field(default=None, description="A record of the patient's informed agreement to participate in the study.")
