...
class Login(MedplumFHIRBase):
    ...
    membership: Optional[Reference] = Field(
        default=None,
    ...
    scope: Optional[str] = Field(default=None, description="OAuth scope or scopes.")
    auth_method: Literal[
    ...
    code_challenge_method: Optional[Literal["plain", "S256"]] = Field(
        default=None,
    ...
    refresh_secret: Optional[str] = Field(
        default=None,
        alias="refreshSecret",
    ...
    mfa_verified: Optional[bool] = Field(
        default=None,
        alias="mfaVerified",
    ...
    super_admin: Optional[bool] = Field(default=None, alias="superAdmin")
    launch: Optional[Reference] = Field(
