...
class DeviceMetric(MedplumFHIRBase):
    ...
    resource_type: Literal["DeviceMetric"] = Field(
        default="DeviceMetric", alias="resourceType"
    )
    ...
    operational_status: Optional[
        Literal["on", "off", "standby", "entered-in-error"]
    ] = Field(
        default=None,
    ...
    measurement_period: Optional[Timing] = Field(
        default=None,
...
class DeviceMetricCalibration(MedplumFHIRBase):
    ...
    type: Optional[Literal["unspecified", "offset", "gain", "two-point"]] = Field(
        default=None, description="Describes the type of the calibration method."
    )
    state: Optional[
        Literal["not-calibrated", "calibration-required", "calibrated", "unspecified"]
    ] = Field(default=None, description="Describes the state of the calibration.")
