...
class CoverageEligibilityResponse(MedplumFHIRBase):
    ...
    insurance: list[CoverageEligibilityResponseInsurance] | None = Field(
        default=None,
    ...
    error: list[CoverageEligibilityResponseError] | None = Field(
        default=None,
...
class CoverageEligibilityResponseInsurance(MedplumFHIRBase):
    ...
    item: list[CoverageEligibilityResponseInsuranceItem] | None = Field(
        default=None,
...
class CoverageEligibilityResponseInsuranceItem(MedplumFHIRBase):
    ...
    benefit: list[CoverageEligibilityResponseInsuranceItemBenefit] | None = Field(
    ...
    authorization_supporting: list[CodeableConcept] | None = Field(
        default=None,
