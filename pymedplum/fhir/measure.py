...
class Measure(MedplumFHIRBase):
    ...
    resource_type: Literal["Measure"] = Field(default="Measure", alias="resourceType")
    ...
    group: list[MeasureGroup] | None = Field(
        default=None, description="A group of population criteria for the measure."
    )
    supplemental_data: list[MeasureSupplementalData] | None = Field(
        default=None,
...
class MeasureGroup(MedplumFHIRBase):
    ...
    population: list[MeasureGroupPopulation] | None = Field(
        default=None, description="A population criteria for the measure."
    )
    stratifier: list[MeasureGroupStratifier] | None = Field(
        default=None,
...
class MeasureGroupStratifier(MedplumFHIRBase):
    ...
    component: list[MeasureGroupStratifierComponent] | None = Field(
        default=None,
...
class MeasureSupplementalData(MedplumFHIRBase):
    ...
    usage: list[CodeableConcept] | None = Field(
        default=None,
