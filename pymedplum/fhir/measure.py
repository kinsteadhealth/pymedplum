...
class Measure(MedplumFHIRBase):
    ...
    composite_scoring: Optional[CodeableConcept] = Field(
        default=None,
    ...
    risk_adjustment: Optional[str] = Field(
        default=None,
    ...
    rate_aggregation: Optional[str] = Field(
        default=None,
    ...
    clinical_recommendation_statement: Optional[str] = Field(
        default=None,
    ...
    supplemental_data: Optional[list[MeasureSupplementalData]] = Field(
        default=None,
