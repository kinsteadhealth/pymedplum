...
class SpecimenDefinition(MedplumFHIRBase):
    ...
    type_tested: Optional[list[SpecimenDefinitionTypeTested]] = Field(
        default=None,
        alias="typeTested",
...
class SpecimenDefinitionTypeTested(MedplumFHIRBase):
    ...
    retention_time: Optional[Duration] = Field(
        default=None,
        alias="retentionTime",
    ...
    rejection_criterion: Optional[list[CodeableConcept]] = Field(
        default=None,
...
class SpecimenDefinitionTypeTestedHandling(MedplumFHIRBase):
    ...
    temperature_qualifier: Optional[CodeableConcept] = Field(
        default=None,
