...
class ResearchElementDefinition(MedplumFHIRBase):
    ...
    resource_type: Literal["ResearchElementDefinition"] = Field(
        default="ResearchElementDefinition", alias="resourceType"
    )
    ...
    variable_type: Optional[Literal["dichotomous", "continuous", "descriptive"]] = (
        Field(
            default=None,
            alias="variableType",
    ...
    characteristic: list[ResearchElementDefinitionCharacteristic] = Field(
        default=...,
...
class ResearchElementDefinitionCharacteristic(MedplumFHIRBase):
    ...
    definition_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
    ...
    definition_expression: Optional[Expression] = Field(
        default=None,
        alias="definitionExpression",
        description="Define members of the research element using Codes (such as condition, medication, or observation), Expressions ( using an expression language such as FHIRPath or CQL) or DataRequirements (such as Diabetes diagnosis onset in the last year).",
    )
    definition_data_requirement: Optional[DataRequirement] = Field(
        default=None,
        alias="definitionDataRequirement",
        description="Define members of the research element using Codes (such as condition, medication, or observation), Expressions ( using an expression language such as FHIRPath or CQL) or DataRequirements (such as Diabetes diagnosis onset in the last year).",
    )
    usage_context: Optional[list[UsageContext]] = Field(
        default=None,
        alias="usageContext",
    ...
    participant_effective_description: Optional[str] = Field(
        default=None,
        alias="participantEffectiveDescription",
        description="A narrative description of the time period the study covers.",
    )
    participant_effective_date_time: Optional[str] = Field(
        default=None,
        alias="participantEffectiveDateTime",
        description="Indicates what effective period the study covers.",
    )
    participant_effective_period: Optional[Period] = Field(
        default=None,
        alias="participantEffectivePeriod",
        description="Indicates what effective period the study covers.",
    )
    participant_effective_duration: Optional[Duration] = Field(
        default=None,
        alias="participantEffectiveDuration",
        description="Indicates what effective period the study covers.",
    )
    participant_effective_timing: Optional[Timing] = Field(
        default=None,
        alias="participantEffectiveTiming",
        description="Indicates what effective period the study covers.",
    )
    participant_effective_time_from_start: Optional[Duration] = Field(
        default=None,
        alias="participantEffectiveTimeFromStart",
        description="Indicates duration from the participant's study entry.",
    )
    participant_effective_group_measure: Optional[
        Literal[
            "mean",
            "median",
            "mean-of-mean",
