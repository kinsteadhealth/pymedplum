...
class CompartmentDefinition(MedplumFHIRBase):
    ...
    resource_type: Literal["CompartmentDefinition"] = Field(
        default="CompartmentDefinition", alias="resourceType"
    )
    ...
    code: Literal["Patient", "Encounter", "RelatedPerson", "Practitioner", "Device"] = (
        Field(default=..., description="Which compartment this definition describes.")
    )
    search: bool = Field(
        default=..., description="Whether the search syntax is supported,."
    )
    resource: list[CompartmentDefinitionResource] | None = Field(
        default=None,
...
class CompartmentDefinitionResource(MedplumFHIRBase):
    ...
    code: ResourceType = Field(
        default=..., description="The name of a resource supported by the server."
    )
    param: list[str] | None = Field(
        default=None,
