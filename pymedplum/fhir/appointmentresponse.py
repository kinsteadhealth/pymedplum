...
class AppointmentResponse(MedplumFHIRBase):
    ...
    resource_type: Literal["AppointmentResponse"] = Field(
        default="AppointmentResponse", alias="resourceType"
    )
    ...
    appointment: Reference = Field(
        default=..., description="Appointment that this response is replying to."
    )
    ...
    participant_type: Optional[List[CodeableConcept]] = Field(
        default=None,
