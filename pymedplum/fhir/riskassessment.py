...
class RiskAssessment(MedplumFHIRBase):
    ...
    based_on: Optional[Reference] = Field(
        default=None,
        alias="basedOn",
...
class RiskAssessmentPrediction(MedplumFHIRBase):
    ...
    probability_decimal: Optional[Union[int, float]] = Field(
        default=None,
        alias="probabilityDecimal",
        description="Indicates how likely the outcome is (in the specified timeframe).",
    )
    probability_range: Optional[Range] = Field(
        default=None,
        alias="probabilityRange",
        description="Indicates how likely the outcome is (in the specified timeframe).",
    )
    qualitative_risk: Optional[CodeableConcept] = Field(
        default=None,
    ...
    relative_risk: Optional[Union[int, float]] = Field(
        default=None,
        alias="relativeRisk",
