...
class MedicinalProductPharmaceuticalRouteOfAdministration(MedplumFHIRBase):
    ...
    first_dose: Optional[Quantity] = Field(
        default=None,
        alias="firstDose",
    ...
    max_single_dose: Optional[Quantity] = Field(
        default=None,
        alias="maxSingleDose",
    ...
    max_dose_per_day: Optional[Quantity] = Field(
        default=None,
        alias="maxDosePerDay",
    ...
    max_dose_per_treatment_period: Optional[Ratio] = Field(
        default=None,
    ...
    max_treatment_period: Optional[Duration] = Field(
        default=None,
...
class MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod(
    ...
    supporting_information: Optional[str] = Field(
        default=None,
