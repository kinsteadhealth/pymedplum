...
class PaymentNotice(MedplumFHIRBase):
    ...
    resource_type: Literal["PaymentNotice"] = Field(
        default="PaymentNotice", alias="resourceType"
    )
    ...
    recipient: Reference = Field(
        default=..., description="The party who is notified of the payment status."
    )
    amount: Money = Field(default=..., description="The amount sent to the payee.")
    payment_status: Optional[CodeableConcept] = Field(
        default=None,
        alias="paymentStatus",
