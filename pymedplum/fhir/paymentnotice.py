...
class PaymentNotice(MedplumFHIRBase):
    ...
    resource_type: Literal["PaymentNotice"] = Field(
    ...
    identifier: Optional[list[Identifier]] = Field(default=None, description="A unique identifier assigned to this payment notice.")
    status: Literal['active', 'cancelled', 'draft', 'entered-in-error'] = Field(default=..., description="The status of the resource instance.")
    request: Optional[Reference] = Field(default=None, description="Reference of resource for which payment is being made.")
    response: Optional[Reference] = Field(default=None, description="Reference of response to resource for which payment is being made.")
    created: str = Field(default=..., description="The date when this resource was created.")
    provider: Optional[Reference] = Field(default=None, description="The practitioner who is responsible for the services rendered to the patient.")
    payment: Reference = Field(default=..., description="A reference to the payment which is the subject of this notice.")
    payment_date: Optional[str] = Field(default=None, alias="paymentDate", description="The date when the above payment action occurred.")
    payee: Optional[Reference] = Field(default=None, description="The party who will receive or has received payment that is the subject of this notification.")
    recipient: Reference = Field(default=..., description="The party who is notified of the payment status.")
    amount: Money = Field(default=..., description="The amount sent to the payee.")
    payment_status: Optional[CodeableConcept] = Field(default=None, alias="paymentStatus", description="A code indicating whether payment has been sent or cleared.")
