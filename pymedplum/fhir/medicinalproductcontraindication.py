...
class MedicinalProductContraindication(MedplumFHIRBase):
    ...
    resource_type: Literal["MedicinalProductContraindication"] = Field(
        default="MedicinalProductContraindication", alias="resourceType"
    )
    ...
    therapeutic_indication: Optional[List[Reference]] = Field(
        default=None,
    ...
    other_therapy: Optional[List[MedicinalProductContraindicationOtherTherapy]] = Field(
        default=None,
        alias="otherTherapy",
