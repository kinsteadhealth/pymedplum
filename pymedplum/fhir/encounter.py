...
class Encounter(MedplumFHIRBase):
    ...
    resource_type: Literal["Encounter"] = Field(
        default="Encounter", alias="resourceType"
    )
    ...
    status_history: Optional[list[EncounterStatusHistory]] = Field(
        default=None,
        alias="statusHistory",
    ...
    service_type: Optional[CodeableConcept] = Field(
        default=None,
        alias="serviceType",
    ...
    episode_of_care: Optional[list[Reference]] = Field(
        default=None,
        alias="episodeOfCare",
    ...
    service_provider: Optional[Reference] = Field(
        default=None,
...
class EncounterClassHistory(MedplumFHIRBase):
    ...
    period: Period = Field(
        default=..., description="The time that the episode was in the specified class."
    )
...
class EncounterDiagnosis(MedplumFHIRBase):
    ...
    use: Optional[CodeableConcept] = Field(
        default=None,
        description="Role that this diagnosis has within the encounter (e.g. admission, billing, discharge &hellip;).",
    )
...
class EncounterHospitalization(MedplumFHIRBase):
    ...
    pre_admission_identifier: Optional[Identifier] = Field(
        default=None,
    ...
    admit_source: Optional[CodeableConcept] = Field(
        default=None,
        alias="admitSource",
        description="From where patient was admitted (physician referral, transfer).",
    )
    re_admission: Optional[CodeableConcept] = Field(
        default=None,
        alias="reAdmission",
        description="Whether this hospitalization is a readmission and why if known.",
    )
    diet_preference: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="dietPreference",
        description="Diet preferences reported by the patient.",
    )
    special_courtesy: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="specialCourtesy",
        description="Special courtesies (VIP, board member).",
    )
    special_arrangement: Optional[list[CodeableConcept]] = Field(
        default=None,
    ...
    discharge_disposition: Optional[CodeableConcept] = Field(
        default=None,
...
class EncounterLocation(MedplumFHIRBase):
    ...
    location: Reference = Field(
        default=..., description="The location where the encounter takes place."
    )
    ...
    physical_type: Optional[CodeableConcept] = Field(
        default=None,
        alias="physicalType",
