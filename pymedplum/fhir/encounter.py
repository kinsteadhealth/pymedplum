...
class Encounter(MedplumFHIRBase):
    ...
    status_history: list[EncounterStatusHistory] | None = Field(
        default=None,
        alias="statusHistory",
    ...
    class_history: list[EncounterClassHistory] | None = Field(
        default=None,
        alias="classHistory",
    ...
    episode_of_care: list[Reference] | None = Field(
        default=None,
        alias="episodeOfCare",
    ...
    participant: list[EncounterParticipant] | None = Field(
        default=None,
        description="The list of people responsible for providing the service.",
    )
    appointment: list[Reference] | None = Field(
    ...
    diagnosis: list[EncounterDiagnosis] | None = Field(
    ...
    location: list[EncounterLocation] | None = Field(
        default=None,
...
class EncounterDiagnosis(MedplumFHIRBase):
    ...
    use: CodeableConcept | None = Field(
        default=None,
...
class EncounterHospitalization(MedplumFHIRBase):
    ...
    diet_preference: list[CodeableConcept] | None = Field(
        default=None,
        alias="dietPreference",
        description="Diet preferences reported by the patient.",
    )
    special_courtesy: list[CodeableConcept] | None = Field(
        default=None,
        alias="specialCourtesy",
        description="Special courtesies (VIP, board member).",
    )
    special_arrangement: list[CodeableConcept] | None = Field(
        default=None,
