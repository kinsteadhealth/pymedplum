...
class BulkDataExport(MedplumFHIRBase):
    ...
    requires_access_token: bool | None = Field(
        default=None,
    ...
    output: list[BulkDataExportOutput] | None = Field(
        default=None,
