...
class ClientApplication(MedplumFHIRBase):
    ...
    status: Optional[Literal["active", "off", "error"]] = Field(
        default=None,
    ...
    sign_in_form: Optional[ClientApplicationSignInForm] = Field(
        default=None,
        alias="signInForm",
    ...
    launch_uri: Optional[str] = Field(
        default=None,
        alias="launchUri",
        description="Optional launch URI for SMART EHR launch sequence.",
    )
    pkce_optional: Optional[bool] = Field(
        default=None,
        alias="pkceOptional",
...
class ClientApplicationSignInForm(MedplumFHIRBase):
    ...
    welcome_string: Optional[str] = Field(
        default=None,
        alias="welcomeString",
        description="Welcome string for the Log In Form.",
    )
    logo: Optional[Attachment] = Field(
