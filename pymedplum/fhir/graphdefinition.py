...
class GraphDefinition(MedplumFHIRBase):
    ...
    resource_type: Literal["GraphDefinition"] = Field(
        default="GraphDefinition", alias="resourceType"
    )
    ...
    link: list[GraphDefinitionLink] | None = Field(
...
class GraphDefinitionLink(MedplumFHIRBase):
    ...
    slice_name: str | None = Field(
        default=None, alias="sliceName", description="Which slice (if profiled)."
    )
    min: int | float | None = Field(
        default=None, description="Minimum occurrences for this link."
    )
    max: str | None = Field(
        default=None, description="Maximum occurrences for this link."
    )
    description: str | None = Field(
        default=None,
        description="Information about why this link is of interest in this graph definition.",
    )
    target: list[GraphDefinitionLinkTarget] | None = Field(
...
class GraphDefinitionLinkTarget(MedplumFHIRBase):
    ...
    type: ResourceType = Field(
        default=..., description="Type of resource this link refers to."
    )
    params: str | None = Field(
        default=None, description="A set of parameters to look up."
    )
    profile: str | None = Field(
        default=None, description="Profile for the target resource."
    )
    compartment: list[GraphDefinitionLinkTargetCompartment] | None = Field(
...
class GraphDefinitionLinkTargetCompartment(MedplumFHIRBase):
    ...
    code: Literal["Patient", "Encounter", "RelatedPerson", "Practitioner", "Device"] = (
        Field(default=..., description="Identifies the compartment.")
    )
    rule: Literal["identical", "matching", "different", "custom"] = Field(
        default=..., description="identical | matching | different | no-rule | custom."
    )
    expression: str | None = Field(
        default=None, description="Custom rule, as a FHIRPath expression."
    )
    description: str | None = Field(
        default=None, description="Documentation for FHIRPath expression."
    )
