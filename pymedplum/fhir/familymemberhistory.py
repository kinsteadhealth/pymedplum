...
class FamilyMemberHistory(MedplumFHIRBase):
    ...
    resource_type: Literal["FamilyMemberHistory"] = Field(
        default="FamilyMemberHistory", alias="resourceType"
    )
    ...
    patient: Reference = Field(
        default=..., description="The person who this history concerns."
    )
    ...
    deceased_age: Optional[Age] = Field(
        default=None,
        alias="deceasedAge",
        description="Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record.",
    )
    deceased_range: Optional[Range] = Field(
        default=None,
        alias="deceasedRange",
        description="Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record.",
    )
