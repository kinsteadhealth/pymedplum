...
class AllergyIntolerance(MedplumFHIRBase):
    ...
    type: Optional[Literal["allergy", "intolerance"]] = Field(
        default=None,
        description="Identification of the underlying physiological mechanism for the reaction risk.",
    )
    category: Optional[
        list[Literal["food", "medication", "environment", "biologic"]]
    ] = Field(default=None, description="Category of the identified substance.")
    criticality: Optional[Literal["low", "high", "unable-to-assess"]] = Field(
        default=None,
    ...
    patient: Reference = Field(
        default=..., description="The patient who has the allergy or intolerance."
    )
...
class AllergyIntoleranceReaction(MedplumFHIRBase):
    ...
    exposure_route: Optional[CodeableConcept] = Field(
        default=None,
        alias="exposureRoute",
