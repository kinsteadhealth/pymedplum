...
class Invoice(MedplumFHIRBase):
    ...
    resource_type: Literal["Invoice"] = Field(default="Invoice", alias="resourceType")
    ...
    status: Literal["draft", "issued", "balanced", "cancelled", "entered-in-error"] = (
        Field(default=..., description="The current state of the Invoice.")
    )
    ...
    line_item: Optional[List[InvoiceLineItem]] = Field(
        default=None,
        alias="lineItem",
    ...
    total_price_component: Optional[List[InvoiceLineItemPriceComponent]] = Field(
        default=None,
    ...
    total_net: Optional[Money] = Field(
        default=None, alias="totalNet", description="Invoice total , taxes excluded."
    )
    total_gross: Optional[Money] = Field(
        default=None, alias="totalGross", description="Invoice total, tax included."
    )
...
class InvoiceLineItem(MedplumFHIRBase):
    ...
    sequence: Optional[Union[int, float]] = Field(
        default=None, description="Sequence in which the items appear on the invoice."
    )
    charge_item_reference: Optional[Reference] = Field(
        default=None,
    ...
    charge_item_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
        alias="chargeItemCodeableConcept",
        description="The ChargeItem contains information such as the billing code, date, amount etc. If no further details are required for the lineItem, inline billing codes can be added using the CodeableConcept data type instead of the Reference.",
    )
    price_component: Optional[List[InvoiceLineItemPriceComponent]] = Field(
        default=None,
