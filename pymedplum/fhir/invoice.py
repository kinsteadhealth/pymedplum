...
class Invoice(MedplumFHIRBase):
    ...
    participant: list[InvoiceParticipant] | None = Field(
        default=None,
    ...
    line_item: list[InvoiceLineItem] | None = Field(
        default=None,
        alias="lineItem",
    ...
    total_price_component: list[InvoiceLineItemPriceComponent] | None = Field(
        default=None,
...
class InvoiceLineItem(MedplumFHIRBase):
    ...
    price_component: list[InvoiceLineItemPriceComponent] | None = Field(
        default=None,
