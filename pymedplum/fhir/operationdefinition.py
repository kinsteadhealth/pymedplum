...
class OperationDefinition(MedplumFHIRBase):
    ...
    resource_type: Literal["OperationDefinition"] = Field(
        default="OperationDefinition", alias="resourceType"
    )
    ...
    kind: Literal["operation", "query"] = Field(
        default=..., description="Whether this is an operation or a named query."
    )
    ...
    resource: list[ResourceType] | None = Field(
        default=None, description="The types on which this operation can be executed."
    )
    system: bool = Field(
        default=...,
    ...
    parameter: list[OperationDefinitionParameter] | None = Field(
        default=None, description="The parameters for the operation/query."
    )
    overload: list[OperationDefinitionOverload] | None = Field(
        default=None,
...
class OperationDefinitionOverload(MedplumFHIRBase):
    ...
    parameter_name: list[str] | None = Field(
        default=None,
        alias="parameterName",
        description="Name of parameter to include in overload.",
    )
    comment: str | None = Field(default=None, description="Comments to go on overload.")
...
class OperationDefinitionParameter(MedplumFHIRBase):
    ...
    name: str = Field(
        default=..., description="The name of used to identify the parameter."
    )
    use: Literal["in", "out"] = Field(
        default=..., description="Whether this is an input or an output parameter."
    )
    min: int | float = Field(
        default=...,
    ...
    type: str | None = Field(default=None, description="The type for this parameter.")
    ...
    referenced_from: list[OperationDefinitionParameterReferencedFrom] | None = Field(
        default=None,
    ...
    part: list[OperationDefinitionParameter] | None = Field(
