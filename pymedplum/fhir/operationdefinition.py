...
class OperationDefinition(MedplumFHIRBase):
    ...
    affects_state: Optional[bool] = Field(
        default=None,
        alias="affectsState",
    ...
    resource: Optional[list[ResourceType]] = Field(
    ...
    input_profile: Optional[str] = Field(
        default=None,
        alias="inputProfile",
    ...
    output_profile: Optional[str] = Field(
        default=None,
        alias="outputProfile",
...
class OperationDefinitionOverload(MedplumFHIRBase):
    ...
    parameter_name: Optional[list[str]] = Field(
        default=None,
        alias="parameterName",
        description="Name of parameter to include in overload.",
    )
    comment: Optional[str] = Field(
        default=None, description="Comments to go on overload."
    )
...
class OperationDefinitionParameter(MedplumFHIRBase):
    ...
    type: Optional[str] = Field(
        default=None, description="The type for this parameter."
    )
    ...
    referenced_from: Optional[list[OperationDefinitionParameterReferencedFrom]] = Field(
        default=None,
