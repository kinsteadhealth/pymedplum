...
class Patient(MedplumFHIRBase):
    ...
    contact: list[PatientContact] | None = Field(
        default=None,
        description="A contact party (e.g. guardian, partner, friend) for the patient.",
    )
    communication: list[PatientCommunication] | None = Field(
        default=None,
        description="A language which may be used to communicate with the patient about his or her health.",
    )
    general_practitioner: list[Reference] | None = Field(
        default=None,
    ...
    link: list[PatientLink] | None = Field(
        default=None,
...
class PatientContact(MedplumFHIRBase):
    ...
    relationship: list[CodeableConcept] | None = Field(
        default=None,
