...
class InsurancePlan(MedplumFHIRBase):
    ...
    owned_by: Optional[Reference] = Field(
        default=None,
        alias="ownedBy",
    ...
    administered_by: Optional[Reference] = Field(
        default=None,
...
class InsurancePlanPlan(MedplumFHIRBase):
    ...
    general_cost: Optional[list[InsurancePlanPlanGeneralCost]] = Field(
        default=None,
        alias="generalCost",
        description="Overall costs associated with the plan.",
    )
    specific_cost: Optional[list[InsurancePlanPlanSpecificCost]] = Field(
        default=None,
        alias="specificCost",
...
class InsurancePlanPlanGeneralCost(MedplumFHIRBase):
    ...
    group_size: Optional[Union[int, float]] = Field(
        default=None,
        alias="groupSize",
