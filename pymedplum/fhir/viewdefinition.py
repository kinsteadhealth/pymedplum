...
class ViewDefinition(MedplumFHIRBase):
    ...
    constant: Optional[list[ViewDefinitionConstant]] = Field(
        default=None,
    ...
    where: Optional[list[ViewDefinitionWhere]] = Field(
        default=None,
...
class ViewDefinitionConstant(MedplumFHIRBase):
    ...
    value_integer64: Optional[str] = Field(
        default=None,
...
class ViewDefinitionSelect(MedplumFHIRBase):
    ...
    column: Optional[list[ViewDefinitionSelectColumn]] = Field(
        default=None,
    ...
    select: Optional[list[ViewDefinitionSelect]] = Field(
        default=None,
    ...
    for_each_or_null: Optional[str] = Field(
        default=None,
        alias="forEachOrNull",
    ...
    union_all: Optional[list[ViewDefinitionSelect]] = Field(
        default=None,
        alias="unionAll",
...
class ViewDefinitionSelectColumn(MedplumFHIRBase):
    ...
    tag: Optional[list[ViewDefinitionSelectColumnTag]] = Field(
        default=None,
