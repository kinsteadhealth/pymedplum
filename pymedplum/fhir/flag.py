...
class Flag(MedplumFHIRBase):
    ...
    resource_type: Literal["Flag"] = Field(
        default="Flag",
        alias="resourceType"
    )
    ...
    identifier: Optional[list[Identifier]] = Field(default=None, description="Business identifiers assigned to this flag by the performer or other systems which remain constant as the resource is updated and propagates from server to server.")
    status: Literal['active', 'inactive', 'entered-in-error'] = Field(default=..., description="Supports basic workflow.")
    category: Optional[list[CodeableConcept]] = Field(default=None, description="Allows a flag to be divided into different categories like clinical, administrative etc. Intended to be used as a means of filtering which flags are displayed to particular user or in a given context.")
    code: CodeableConcept = Field(default=..., description="The coded value or textual component of the flag to display to the user.")
    subject: Reference = Field(default=..., description="The patient, location, group, organization, or practitioner etc. this is about record this flag is associated with.")
    period: Optional[Period] = Field(default=None, description="The period of time from the activation of the flag to inactivation of the flag. If the flag is active, the end of the period should be unspecified.")
    encounter: Optional[Reference] = Field(default=None, description="This alert is only relevant during the encounter.")
    author: Optional[Reference] = Field(default=None, description="The person, organization or device that created the flag.")
