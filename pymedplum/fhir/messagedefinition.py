...
class MessageDefinition(MedplumFHIRBase):
    ...
    event_coding: Optional[Coding] = Field(
        default=None,
        alias="eventCoding",
        description="Event code or link to the EventDefinition.",
    )
    event_uri: Optional[str] = Field(
        default=None,
        alias="eventUri",
        description="Event code or link to the EventDefinition.",
    )
    category: Optional[Literal["consequence", "currency", "notification"]] = Field(
    ...
    response_required: Optional[
        Literal["always", "on-error", "never", "on-success"]
    ] = Field(
        default=None,
    ...
    allowed_response: Optional[List[MessageDefinitionAllowedResponse]] = Field(
        default=None,
