...
class RelatedPerson(MedplumFHIRBase):
    ...
    resource_type: Literal["RelatedPerson"] = Field(
        default="RelatedPerson", alias="resourceType"
    )
    ...
    patient: Reference = Field(
        default=..., description="The patient this person is related to."
    )
    ...
    communication: list[RelatedPersonCommunication] | None = Field(
        default=None,
