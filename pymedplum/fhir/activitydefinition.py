...
class ActivityDefinition(MedplumFHIRBase):
    ...
    specimen_requirement: Optional[List[Reference]] = Field(
        default=None,
    ...
    observation_requirement: Optional[List[Reference]] = Field(
        default=None,
    ...
    observation_result_requirement: Optional[List[Reference]] = Field(
        default=None,
    ...
    dynamic_value: Optional[List[ActivityDefinitionDynamicValue]] = Field(
        default=None,
        alias="dynamicValue",
