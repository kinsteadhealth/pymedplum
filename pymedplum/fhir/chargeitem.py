...
class ChargeItem(MedplumFHIRBase):
    ...
    entered_date: Optional[str] = Field(
        default=None,
        alias="enteredDate",
    ...
    service: Optional[List[Union[Reference]]] = Field(
        default=None,
