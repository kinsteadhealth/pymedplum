...
class Goal(MedplumFHIRBase):
    ...
    achievement_status: Optional[CodeableConcept] = Field(
        default=None,
    ...
    start_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
    ...
    expressed_by: Optional[Reference] = Field(
        default=None,
        alias="expressedBy",
    ...
    outcome_code: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="outcomeCode",
...
class GoalTarget(MedplumFHIRBase):
    ...
    detail_string: Optional[str] = Field(
        default=None,
        alias="detailString",
        description="The target value of the focus to be achieved to signify the fulfillment of the goal, e.g. 150 pounds, 7.0%. Either the high or low or both values of the range can be specified. When a low value is missing, it indicates that the goal is achieved at any focus value at or below the high value. Similarly, if the high value is missing, it indicates that the goal is achieved at any focus value at or above the low value.",
    )
    detail_boolean: Optional[bool] = Field(
        default=None,
        alias="detailBoolean",
        description="The target value of the focus to be achieved to signify the fulfillment of the goal, e.g. 150 pounds, 7.0%. Either the high or low or both values of the range can be specified. When a low value is missing, it indicates that the goal is achieved at any focus value at or below the high value. Similarly, if the high value is missing, it indicates that the goal is achieved at any focus value at or above the low value.",
    )
    detail_integer: Optional[Union[int, float]] = Field(
        default=None,
        alias="detailInteger",
        description="The target value of the focus to be achieved to signify the fulfillment of the goal, e.g. 150 pounds, 7.0%. Either the high or low or both values of the range can be specified. When a low value is missing, it indicates that the goal is achieved at any focus value at or below the high value. Similarly, if the high value is missing, it indicates that the goal is achieved at any focus value at or above the low value.",
    )
    detail_ratio: Optional[Ratio] = Field(
        default=None,
        alias="detailRatio",
        description="The target value of the focus to be achieved to signify the fulfillment of the goal, e.g. 150 pounds, 7.0%. Either the high or low or both values of the range can be specified. When a low value is missing, it indicates that the goal is achieved at any focus value at or below the high value. Similarly, if the high value is missing, it indicates that the goal is achieved at any focus value at or above the low value.",
    )
    ...
    due_duration: Optional[Duration] = Field(
        default=None,
        alias="dueDuration",
        description="Indicates either the date or the duration after start by which the goal should be met.",
    )
