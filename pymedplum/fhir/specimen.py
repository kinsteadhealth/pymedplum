...
class Specimen(MedplumFHIRBase):
    ...
    resource_type: Literal["Specimen"] = Field(default="Specimen", alias="resourceType")
    ...
    identifier: Optional[List[Identifier]] = Field(
        default=None, description="Id for specimen."
    )
    accession_identifier: Optional[Identifier] = Field(
        default=None,
    ...
    status: Optional[
        Literal["available", "unavailable", "unsatisfactory", "entered-in-error"]
    ] = Field(default=None, description="The availability of the specimen.")
...
class SpecimenCollection(MedplumFHIRBase):
    ...
    fasting_status_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
    ...
    fasting_status_duration: Optional[Duration] = Field(
        default=None,
...
class SpecimenContainer(MedplumFHIRBase):
    ...
    specimen_quantity: Optional[Quantity] = Field(
        default=None,
    ...
    additive_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
    ...
    additive_reference: Optional[Reference] = Field(
        default=None,
...
class SpecimenProcessing(MedplumFHIRBase):
    ...
    description: Optional[str] = Field(
        default=None, description="Textual description of procedure."
    )
    ...
    time_date_time: Optional[str] = Field(
        default=None,
        alias="timeDateTime",
    ...
    time_period: Optional[Period] = Field(
        default=None,
        alias="timePeriod",
        description="A record of the time or period when the specimen processing occurred. For example the time of sample fixation or the period of time the sample was in formalin.",
    )
