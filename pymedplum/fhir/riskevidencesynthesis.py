...
class RiskEvidenceSynthesis(MedplumFHIRBase):
    ...
    sample_size: Optional[RiskEvidenceSynthesisSampleSize] = Field(
        default=None,
        alias="sampleSize",
        description="A description of the size of the sample involved in the synthesis.",
    )
    risk_estimate: Optional[RiskEvidenceSynthesisRiskEstimate] = Field(
        default=None,
        alias="riskEstimate",
