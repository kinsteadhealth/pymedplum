...
class RiskEvidenceSynthesis(MedplumFHIRBase):
    ...
    resource_type: Literal["RiskEvidenceSynthesis"] = Field(
        default="RiskEvidenceSynthesis", alias="resourceType"
    )
    ...
    sample_size: RiskEvidenceSynthesisSampleSize | None = Field(
        default=None,
        alias="sampleSize",
        description="A description of the size of the sample involved in the synthesis.",
    )
    risk_estimate: RiskEvidenceSynthesisRiskEstimate | None = Field(
        default=None,
        alias="riskEstimate",
        description="The estimated risk of the outcome.",
    )
    certainty: list[RiskEvidenceSynthesisCertainty] | None = Field(
...
class RiskEvidenceSynthesisCertainty(MedplumFHIRBase):
    ...
    rating: list[CodeableConcept] | None = Field(
...
class RiskEvidenceSynthesisRiskEstimate(MedplumFHIRBase):
    ...
    description: str | None = Field(
        default=None, description="Human-readable summary of risk estimate."
    )
    type: CodeableConcept | None = Field(
        default=None, description="Examples include proportion and mean."
    )
    value: int | float | None = Field(
        default=None, description="The point estimate of the risk estimate."
    )
