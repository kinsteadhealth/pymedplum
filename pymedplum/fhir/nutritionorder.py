...
class NutritionOrder(MedplumFHIRBase):
    ...
    allergy_intolerance: list[Reference] | None = Field(
        default=None,
    ...
    food_preference_modifier: list[CodeableConcept] | None = Field(
        default=None,
    ...
    exclude_food_modifier: list[CodeableConcept] | None = Field(
        default=None,
    ...
    supplement: list[NutritionOrderSupplement] | None = Field(
        default=None,
...
class NutritionOrderEnteralFormula(MedplumFHIRBase):
    ...
    administration: list[NutritionOrderEnteralFormulaAdministration] | None = Field(
        default=None,
...
class NutritionOrderOralDiet(MedplumFHIRBase):
    ...
    schedule: list[Timing] | None = Field(
        default=None,
    ...
    nutrient: list[NutritionOrderOralDietNutrient] | None = Field(
        default=None,
    ...
    texture: list[NutritionOrderOralDietTexture] | None = Field(
        default=None,
    ...
    fluid_consistency_type: list[CodeableConcept] | None = Field(
        default=None,
