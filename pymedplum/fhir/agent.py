...
class Agent(MedplumFHIRBase):
    ...
    resource_type: Literal["Agent"] = Field(default="Agent", alias="resourceType")
    ...
    name: str = Field(
        default=..., description="The human readable friendly name of the agent."
    )
    status: Literal["active", "off", "error"] = Field(
        default=..., description="The status of the agent."
    )
    device: Optional[Reference] = Field(
        default=None,
        description="Optional device resource representing the device running the agent.",
    )
    setting: Optional[list[AgentSetting]] = Field(
        default=None, description="The settings for the agent."
    )
    channel: Optional[list[AgentChannel]] = Field(
        default=None,
...
class AgentSetting(MedplumFHIRBase):
    ...
    value_string: Optional[str] = Field(
        default=None, alias="valueString", description="The setting value."
    )
    value_boolean: Optional[bool] = Field(
        default=None, alias="valueBoolean", description="The setting value."
    )
    value_decimal: Optional[Union[int, float]] = Field(
        default=None, alias="valueDecimal", description="The setting value."
    )
    value_integer: Optional[Union[int, float]] = Field(
        default=None, alias="valueInteger", description="The setting value."
    )
