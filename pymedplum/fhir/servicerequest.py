...
class ServiceRequest(MedplumFHIRBase):
    ...
    order_detail: Optional[List[CodeableConcept]] = Field(
        default=None,
        alias="orderDetail",
    ...
    quantity_quantity: Optional[Quantity] = Field(
        default=None,
    ...
    quantity_ratio: Optional[Ratio] = Field(
        default=None,
        alias="quantityRatio",
        description="An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction).",
    )
    quantity_range: Optional[Range] = Field(
        default=None,
        alias="quantityRange",
        description="An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction).",
    )
    ...
    location_code: Optional[List[CodeableConcept]] = Field(
        default=None,
        alias="locationCode",
    ...
    location_reference: Optional[List[Reference]] = Field(
        default=None,
