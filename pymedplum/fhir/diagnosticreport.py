...
class DiagnosticReport(MedplumFHIRBase):
    ...
    results_interpreter: list[Reference] | None = Field(
        default=None,
    ...
    imaging_study: list[Reference] | None = Field(
        default=None,
        alias="imagingStudy",
    ...
    media: list[DiagnosticReportMedia] | None = Field(
        default=None,
    ...
    conclusion_code: list[CodeableConcept] | None = Field(
        default=None,
    ...
    presented_form: list[Attachment] | None = Field(
        default=None,
        alias="presentedForm",
