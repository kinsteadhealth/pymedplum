...
class DeviceRequest(MedplumFHIRBase):
    ...
    resource_type: Literal["DeviceRequest"] = Field(
        default="DeviceRequest", alias="resourceType"
    )
    ...
    prior_request: Optional[List[Reference]] = Field(
        default=None,
        alias="priorRequest",
    ...
    code_reference: Optional[Reference] = Field(
        default=None,
        alias="codeReference",
        description="The details of the device to be used.",
    )
    code_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
    ...
    subject: Reference = Field(
        default=..., description="The patient who will use the device."
    )
