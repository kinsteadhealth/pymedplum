...
class SupplyRequest(MedplumFHIRBase):
    ...
    resource_type: Literal["SupplyRequest"] = Field(
        default="SupplyRequest", alias="resourceType"
    )
    ...
    ] = Field(default=None, description="Status of the supply request.")
    ...
    authored_on: Optional[str] = Field(
        default=None, alias="authoredOn", description="When the request was made."
    )
    ...
    deliver_from: Optional[Reference] = Field(
        default=None,
        alias="deliverFrom",
        description="Where the supply is expected to come from.",
    )
    deliver_to: Optional[Reference] = Field(
        default=None,
        alias="deliverTo",
...
class SupplyRequestParameter(MedplumFHIRBase):
    ...
    value_range: Optional[Range] = Field(
        default=None, alias="valueRange", description="The value of the device detail."
    )
