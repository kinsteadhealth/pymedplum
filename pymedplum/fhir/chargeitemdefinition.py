...
class ChargeItemDefinition(MedplumFHIRBase):
    ...
    derived_from_uri: list[str] | None = Field(
        default=None,
...
class ChargeItemDefinitionPropertyGroup(MedplumFHIRBase):
    ...
    price_component: list[ChargeItemDefinitionPropertyGroupPriceComponent] | None = (
        Field(
            default=None,
