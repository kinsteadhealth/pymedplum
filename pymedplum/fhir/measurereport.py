...
class MeasureReport(MedplumFHIRBase):
    ...
    improvement_notation: Optional[CodeableConcept] = Field(
        default=None,
    ...
    evaluated_resource: Optional[list[Reference]] = Field(
        default=None,
...
class MeasureReportGroup(MedplumFHIRBase):
    ...
    measure_score: Optional[Quantity] = Field(
        default=None,
        alias="measureScore",
...
class MeasureReportGroupPopulation(MedplumFHIRBase):
    ...
    subject_results: Optional[Reference] = Field(
        default=None,
