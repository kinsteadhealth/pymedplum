...
class MeasureReport(MedplumFHIRBase):
    ...
    resource_type: Literal["MeasureReport"] = Field(
        default="MeasureReport", alias="resourceType"
    )
...
class MeasureReportGroup(MedplumFHIRBase):
    ...
    population: list[MeasureReportGroupPopulation] | None = Field(
        default=None,
    ...
    stratifier: list[MeasureReportGroupStratifier] | None = Field(
        default=None,
...
class MeasureReportGroupPopulation(MedplumFHIRBase):
    ...
    code: CodeableConcept | None = Field(
        default=None, description="The type of the population."
    )
    count: int | float | None = Field(
        default=None, description="The number of members of the population."
    )
...
class MeasureReportGroupStratifier(MedplumFHIRBase):
    ...
    stratum: list[MeasureReportGroupStratifierStratum] | None = Field(
        default=None,
...
class MeasureReportGroupStratifierStratum(MedplumFHIRBase):
    ...
    component: list[MeasureReportGroupStratifierStratumComponent] | None = Field(
        default=None, description="A stratifier component value."
    )
    population: list[MeasureReportGroupStratifierStratumPopulation] | None = Field(
        default=None,
...
class MeasureReportGroupStratifierStratumComponent(MedplumFHIRBase):
    ...
    code: CodeableConcept = Field(
        default=..., description="The code for the stratum component value."
    )
    value: CodeableConcept = Field(
        default=..., description="The stratum component value."
    )
