...
class PlanDefinition(MedplumFHIRBase):
    ...
    goal: list[PlanDefinitionGoal] | None = Field(
        default=None,
    ...
    action: list[PlanDefinitionAction] | None = Field(
        default=None,
...
class PlanDefinitionAction(MedplumFHIRBase):
    ...
    participant: list[PlanDefinitionActionParticipant] | None = Field(
        default=None,
    ...
    dynamic_value: list[PlanDefinitionActionDynamicValue] | None = Field(
        default=None,
        alias="dynamicValue",
...
class PlanDefinitionGoal(MedplumFHIRBase):
    ...
    addresses: list[CodeableConcept] | None = Field(
        default=None,
    ...
    target: list[PlanDefinitionGoalTarget] | None = Field(
        default=None,
