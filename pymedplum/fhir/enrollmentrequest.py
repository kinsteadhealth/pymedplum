...
class EnrollmentRequest(MedplumFHIRBase):
    """This resource provides the insurance enrollment details to the insurer
    regarding a specified coverage.
    """

    resource_type: Literal["EnrollmentRequest"] = Field(
    ...
    created: Optional[str] = Field(default=None, description="The date when this resource was created.")
    ...
    candidate: Optional[Reference] = Field(default=None, description="Patient Resource.")
    coverage: Optional[Reference] = Field(default=None, description="Reference to the program or plan identification, underwriter or payor.")
...
if not TYPE_CHECKING:
    ...
    register_model("EnrollmentRequest", EnrollmentRequest)
