...
class TestScriptMetadataCapability(MedplumFHIRBase):
    ...
    origin: Optional[list[Union[int, float]]] = Field(
        default=None, description="Which origin server these requirements apply to."
    )
    destination: Optional[Union[int, float]] = Field(
...
class TestScriptSetupActionAssert(MedplumFHIRBase):
    ...
    direction: Optional[Literal["response", "request"]] = Field(
        default=None, description="The direction to use for the assertion."
    )
    compare_to_source_id: Optional[str] = Field(
        default=None,
    ...
    compare_to_source_expression: Optional[str] = Field(
        default=None,
    ...
    compare_to_source_path: Optional[str] = Field(
        default=None,
    ...
    validate_profile_id: Optional[str] = Field(
        default=None,
...
class TestScriptSetupActionOperation(MedplumFHIRBase):
    ...
    origin: Optional[Union[int, float]] = Field(
        default=None,
    ...
    request_header: Optional[list[TestScriptSetupActionOperationRequestHeader]] = Field(
        default=None,
        alias="requestHeader",
