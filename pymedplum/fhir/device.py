...
class Device(MedplumFHIRBase):
    ...
    udi_carrier: Optional[List[DeviceUdiCarrier]] = Field(
        default=None,
        alias="udiCarrier",
    ...
    status: Optional[Literal["active", "inactive", "entered-in-error", "unknown"]] = (
        Field(default=None, description="Status of the Device availability.")
    )
    status_reason: Optional[List[CodeableConcept]] = Field(
        default=None,
        alias="statusReason",
        description="Reason for the dtatus of the Device availability.",
    )
    distinct_identifier: Optional[str] = Field(
        default=None,
    ...
    device_name: Optional[List[DeviceDeviceName]] = Field(
        default=None,
        alias="deviceName",
    ...
    property: Optional[List[DeviceProperty]] = Field(
        default=None,
...
class DeviceUdiCarrier(MedplumFHIRBase):
    ...
    carrier_a_i_d_c: Optional[str] = Field(
        default=None,
        alias="carrierAIDC",
    ...
    carrier_h_r_f: Optional[str] = Field(
        default=None,
        alias="carrierHRF",
    ...
    entry_type: Optional[
        Literal["barcode", "rfid", "manual", "card", "self-reported", "unknown"]
    ] = Field(
        default=None,
        alias="entryType",
