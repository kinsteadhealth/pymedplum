...
class SubscriptionStatus(MedplumFHIRBase):
    ...
    status: Literal["requested", "active", "error", "off"] | None = Field(
        default=None,
    ...
    events_since_subscription_start: str | None = Field(
        default=None,
    ...
    notification_event: list[SubscriptionStatusNotificationEvent] | None = Field(
        default=None,
    ...
    error: list[CodeableConcept] | None = Field(
        default=None,
...
class SubscriptionStatusNotificationEvent(MedplumFHIRBase):
    ...
    additional_context: list[Reference] | None = Field(
        default=None,
