...
class EpisodeOfCare(MedplumFHIRBase):
    ...
    resource_type: Literal["EpisodeOfCare"] = Field(
        default="EpisodeOfCare", alias="resourceType"
    )
    ...
    status_history: list[EpisodeOfCareStatusHistory] | None = Field(
        default=None,
        alias="statusHistory",
    ...
    diagnosis: list[EpisodeOfCareDiagnosis] | None = Field(
        default=None,
        description="The list of diagnosis relevant to this episode of care.",
    )
    patient: Reference = Field(
        default=..., description="The patient who is the focus of this episode of care."
    )
    ...
    referral_request: list[Reference] | None = Field(
        default=None,
    ...
    team: list[Reference] | None = Field(
        default=None,
...
class EpisodeOfCareDiagnosis(MedplumFHIRBase):
    ...
    role: CodeableConcept | None = Field(
        default=None,
        description="Role that this diagnosis has within the episode of care (e.g. admission, billing, discharge &hellip;).",
    )
