...
class PractitionerRole(MedplumFHIRBase):
    ...
    healthcare_service: list[Reference] | None = Field(
        default=None,
    ...
    available_time: list[PractitionerRoleAvailableTime] | None = Field(
        default=None,
        alias="availableTime",
    ...
    not_available: list[PractitionerRoleNotAvailable] | None = Field(
        default=None,
        alias="notAvailable",
