...
class ImmunizationEvaluation(MedplumFHIRBase):
    ...
    identifier: Optional[list[Identifier]] = Field(default=None, description="A unique identifier assigned to this immunization evaluation record.")
    status: Literal['completed', 'entered-in-error'] = Field(default=..., description="Indicates the current status of the evaluation of the vaccination administration event.")
    patient: Reference = Field(default=..., description="The individual for whom the evaluation is being done.")
    date: Optional[str] = Field(default=None, description="The date the evaluation of the vaccine administration event was performed.")
    authority: Optional[Reference] = Field(default=None, description="Indicates the authority who published the protocol (e.g. ACIP).")
    target_disease: CodeableConcept = Field(default=..., alias="targetDisease", description="The vaccine preventable disease the dose is being evaluated against.")
    immunization_event: Reference = Field(default=..., alias="immunizationEvent", description="The vaccine administration event being evaluated.")
    dose_status: CodeableConcept = Field(default=..., alias="doseStatus", description="Indicates if the dose is valid or not valid with respect to the published recommendations.")
    dose_status_reason: Optional[list[CodeableConcept]] = Field(default=None, alias="doseStatusReason", description="Provides an explanation as to why the vaccine administration event is valid or not relative to the published recommendations.")
    description: Optional[str] = Field(default=None, description="Additional information about the evaluation.")
...
if not TYPE_CHECKING:
    ...
    register_model("ImmunizationEvaluation", ImmunizationEvaluation)
