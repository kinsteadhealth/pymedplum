...
class Dosage(MedplumFHIRBase):
    ...
    additional_instruction: Optional[list[CodeableConcept]] = Field(
        default=None,
    ...
    as_needed_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
    ...
    dose_and_rate: Optional[list[DosageDoseAndRate]] = Field(
        default=None,
        alias="doseAndRate",
        description="The amount of medication administered.",
    )
    max_dose_per_period: Optional[Ratio] = Field(
        default=None,
        alias="maxDosePerPeriod",
        description="Upper limit on medication per unit of time.",
    )
    max_dose_per_administration: Optional[Quantity] = Field(
        default=None,
        alias="maxDosePerAdministration",
        description="Upper limit on medication per administration.",
    )
    max_dose_per_lifetime: Optional[Quantity] = Field(
        default=None,
...
class DosageDoseAndRate(MedplumFHIRBase):
    ...
    dose_range: Optional[Range] = Field(
    ...
    rate_range: Optional[Range] = Field(
        default=None,
        alias="rateRange",
        description="Amount of medication per unit of time.",
    )
