...
class MedicinalProductInteraction(MedplumFHIRBase):
    ...
    subject: Optional[list[Reference]] = Field(default=None, description="The medication for which this is a described interaction.")
    description: Optional[str] = Field(default=None, description="The interaction described.")
    interactant: Optional[list[MedicinalProductInteractionInteractant]] = Field(default=None, description="The specific medication, food or laboratory test that interacts.")
    type: Optional[CodeableConcept] = Field(default=None, description="The type of the interaction e.g. drug-drug interaction, drug-food interaction, drug-lab test interaction.")
    effect: Optional[CodeableConcept] = Field(default=None, description="The effect of the interaction, for example &quot;reduced gastric absorption of primary medication&quot;.")
    incidence: Optional[CodeableConcept] = Field(default=None, description="The incidence of the interaction, e.g. theoretical, observed.")
    management: Optional[CodeableConcept] = Field(default=None, description="Actions for managing the interaction.")
...
class MedicinalProductInteractionInteractant(MedplumFHIRBase):
    ...
    item_reference: Optional[Reference] = Field(default=None, alias="itemReference", description="The specific medication, food or laboratory test that interacts.")
    item_codeable_concept: Optional[CodeableConcept] = Field(default=None, alias="itemCodeableConcept", description="The specific medication, food or laboratory test that interacts.")
...
if not TYPE_CHECKING:
    ...
    register_model("MedicinalProductInteraction", MedicinalProductInteraction)
    register_model("MedicinalProductInteractionInteractant", MedicinalProductInteractionInteractant)
