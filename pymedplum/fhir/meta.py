...
class Meta(MedplumFHIRBase):
    ...
    project: str | None = Field(
        default=None, description="The project that contains this resource."
    )
    ...
    on_behalf_of: Reference | None = Field(
        default=None,
        alias="onBehalfOf",
        description="Optional individual, device, or organization for whom the change was made.",
    )
    account: Reference | None = Field(default=None)
    accounts: list[Reference] | None = Field(
        default=None,
        description="Optional account references that can be used for sub-project compartments.",
    )
    compartment: list[Reference] | None = Field(
        default=None, description="The list of compartments containing this resource"
    )
