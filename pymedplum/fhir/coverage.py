...
class Coverage(MedplumFHIRBase):
    ...
    class_: list[CoverageClass] | None = Field(
        default=None,
        alias="class",
    ...
    cost_to_beneficiary: list[CoverageCostToBeneficiary] | None = Field(
        default=None,
    ...
    contract: list[Reference] | None = Field(
        default=None,
...
class CoverageCostToBeneficiary(MedplumFHIRBase):
    ...
    exception: list[CoverageCostToBeneficiaryException] | None = Field(
        default=None,
