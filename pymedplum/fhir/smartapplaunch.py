...
class SmartAppLaunch(MedplumFHIRBase):
    ...
    patient: Optional[Reference] = Field(default=None, description="Optional patient indicating that the app was launched in the patient context.")
    encounter: Optional[Reference] = Field(default=None, description="Optional encounter indicating that the app was launched in the encounter context.")
...
if not TYPE_CHECKING:
    ...
    register_model("SmartAppLaunch", SmartAppLaunch)
