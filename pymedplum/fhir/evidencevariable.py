...
class EvidenceVariable(MedplumFHIRBase):
    ...
    type: Optional[Literal["dichotomous", "continuous", "descriptive"]] = Field(
        default=None,
...
class EvidenceVariableCharacteristic(MedplumFHIRBase):
    ...
    definition_reference: Optional[Reference] = Field(
        default=None,
    ...
    definition_by_type_and_value: Optional[
    ...
    definition_by_combination: Optional[
    ...
    instances_quantity: Optional[Quantity] = Field(
        default=None,
        alias="instancesQuantity",
        description="Number of occurrences meeting the characteristic.",
    )
    instances_range: Optional[Range] = Field(
        default=None,
        alias="instancesRange",
        description="Number of occurrences meeting the characteristic.",
    )
    duration_quantity: Optional[Quantity] = Field(
        default=None,
        alias="durationQuantity",
        description="Length of time in which the characteristic is met.",
    )
    duration_range: Optional[Range] = Field(
        default=None,
        alias="durationRange",
        description="Length of time in which the characteristic is met.",
    )
    time_from_event: Optional[List[EvidenceVariableCharacteristicTimeFromEvent]] = (
        Field(
            default=None,
            alias="timeFromEvent",
...
class EvidenceVariableCharacteristicTimeFromEvent(MedplumFHIRBase):
    ...
    event_codeable_concept: Optional[CodeableConcept] = Field(
        default=None,
        alias="eventCodeableConcept",
        description="The event used as a base point (reference point) in time.",
    )
    event_reference: Optional[Reference] = Field(
        default=None,
