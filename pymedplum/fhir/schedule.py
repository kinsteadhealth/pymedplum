...
class Schedule(MedplumFHIRBase):
    """A container for slots of time that may be available for booking appointments."""

    resource_type: Literal["Schedule"] = Field(
        default="Schedule",
        alias="resourceType"
    )
    ...
    active: Optional[bool] = Field(default=None, description="Whether this schedule record is in active use or should not be used (such as was entered in error).")
    ...
    actor: list[Reference] = Field(default=..., description="Slots that reference this schedule resource provide the availability details to these referenced resource(s).")
    planning_horizon: Optional[Period] = Field(default=None, alias="planningHorizon", description="The period of time that the slots that reference this Schedule resource cover (even if none exist). These cover the amount of time that an organization's planning horizon; the interval for which they are currently accepting appointments. This does not define a &quot;template&quot; for planning outside these dates.")
    comment: Optional[str] = Field(default=None, description="Comments on the availability to describe any extended information. Such as custom constraints on the slots that may be associated.")
...
if not TYPE_CHECKING:
    ...
    register_model("Schedule", Schedule)
