...
class MedicinalProductPackaged(MedplumFHIRBase):
    ...
    marketing_authorization: Optional[Reference] = Field(
        default=None,
    ...
    batch_identifier: Optional[list[MedicinalProductPackagedBatchIdentifier]] = Field(
...
class MedicinalProductPackagedBatchIdentifier(MedplumFHIRBase):
    ...
    immediate_packaging: Optional[Identifier] = Field(
        default=None,
...
class MedicinalProductPackagedPackageItem(MedplumFHIRBase):
    ...
    alternate_material: Optional[list[CodeableConcept]] = Field(
        default=None,
    ...
    manufactured_item: Optional[list[Reference]] = Field(
        default=None,
        alias="manufacturedItem",
        description="The manufactured item as contained in the packaged medicinal product.",
    )
    package_item: Optional[list[MedicinalProductPackagedPackageItem]] = Field(
        default=None,
        alias="packageItem",
        description="Allows containers within containers.",
    )
    physical_characteristics: Optional[ProdCharacteristic] = Field(
        default=None,
        alias="physicalCharacteristics",
        description="Dimensions, color etc.",
    )
    other_characteristics: Optional[list[CodeableConcept]] = Field(
        default=None,
        alias="otherCharacteristics",
        description="Other codeable characteristics.",
    )
    shelf_life_storage: Optional[list[ProductShelfLife]] = Field(
        default=None,
