...
class SubstanceNucleicAcid(MedplumFHIRBase):
    ...
    area_of_hybridisation: Optional[str] = Field(
        default=None,
    ...
    oligo_nucleotide_type: Optional[CodeableConcept] = Field(
...
class SubstanceNucleicAcidSubunit(MedplumFHIRBase):
    ...
    five_prime: Optional[CodeableConcept] = Field(
        default=None,
        alias="fivePrime",
    ...
    three_prime: Optional[CodeableConcept] = Field(
        default=None,
        alias="threePrime",
...
class SubstanceNucleicAcidSubunitLinkage(MedplumFHIRBase):
    ...
    residue_site: Optional[str] = Field(
        default=None,
        alias="residueSite",
