...
class MedicinalProductUndesirableEffect(MedplumFHIRBase):
    """Describe the undesirable effects of the medicinal product."""

    resource_type: Literal["MedicinalProductUndesirableEffect"] = Field(
    ...
    symptom_condition_effect: Optional[CodeableConcept] = Field(default=None, alias="symptomConditionEffect", description="The symptom, condition or undesirable effect.")
    classification: Optional[CodeableConcept] = Field(default=None, description="Classification of the effect.")
    frequency_of_occurrence: Optional[CodeableConcept] = Field(default=None, alias="frequencyOfOccurrence", description="The frequency of occurrence of the effect.")
...
if not TYPE_CHECKING:
    ...
    register_model("MedicinalProductUndesirableEffect", MedicinalProductUndesirableEffect)
