...
class MedicinalProductUndesirableEffect(MedplumFHIRBase):
    ...
    resource_type: Literal["MedicinalProductUndesirableEffect"] = Field(
        default="MedicinalProductUndesirableEffect", alias="resourceType"
    )
    ...
    symptom_condition_effect: Optional[CodeableConcept] = Field(
        default=None,
    ...
    frequency_of_occurrence: Optional[CodeableConcept] = Field(
        default=None,
