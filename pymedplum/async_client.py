...
class AsyncMedplumClient(BaseClient):
    ...
    async def _refresh_and_retry_once(
        ...
        *,
        ...
        """
        try:
            await self._tokens.force_refresh(self._http, stale_token=stale_token)
    ...
    async def conditional_create_batch(
        self,
    ...
    async def update_resource(
        ...
        *,
        ...
        Examples:
            ...
            updated = await client.update_resource(patient, if_match="required")
        """
        data = to_fhir_json(resource)
    ...
    async def update_with_retry(
        ...
        *,
        ...
        that can't repeat. It is called synchronously — do the reads
        your mutation depends on before starting the loop.
        ...
        Example:
            ...
            result = await client.update_with_retry(
                "Patient", "123", deactivate
            )
            if result.wrote:
        ...
        attempt = 0
        while True:
            current = await self.read_resource(
            ...
            try:
                updated = await self.update_resource(
                    new_state,
            ...
            if not isinstance(new_version, str) or not new_version:
                ...
                resource_after = await self.read_resource(
                    resource_type, resource_id, on_behalf_of=on_behalf_of
                )
    ...
    async def patch_resource(
        ...
        *,
        ...
        Examples:
            ...
            patient = await client.read_resource("Patient", "123")
            patched = await client.patch_resource(
                "Patient",
                "123",
                operations,
    ...
    async def set_accounts(
        ...
        *,
        ...
        Examples:
            ...
            result = await client.set_accounts(
                "Patient/123",
                "Organization/org-a",
                propagate=True,
                prefer_async=True,
            )
            job = await client.wait_for_async_job(result, timeout=60)
        """
    ...
    async def _merge_pm_access_with_mutator(
        ...
        *,
        ...
        result = await self.update_with_retry(
            "ProjectMembership",
            bare_id,
            resource_mutator,
            max_retries=max_retries,
    ...
    async def get_async_job_status(
        ...
        Example:
            ...
            job = await client.get_async_job_status(result)
        """
    ...
    async def wait_for_async_job(
        ...
        while True:
            status_response = await self._request("GET", url)
